...
# Paper Author:Ana M. Girão Coelho, J. Toby Mottram
'https://www.sciencedirect.com/science/article/abs/pii/S0261306915000576'    
...
def MOMENT_CURVATURE(secTag):
    ...
    fy = random.uniform(980, 1000)     # Yield stress for bolt
    ey = random.uniform(0.0049, 0.005) # Yield strain for bolt
    esu = random.uniform(0.10, 0.12)   # Ultimate strain for bolt
    ...
    # Set some parameters
    plateWidth = 220 #random.uniform(395, 405)
    plateDepth = 540 #random.uniform(595, 605)

    cover = random.uniform(45, 55)        # Bolt section cover
    cover02 = random.uniform(145, 155)    # Bolt section in middle layer
    RZD = random.uniform(23.5, 24.5)      # Bolt Size Diameter
...
results_df.to_excel('MOMENT_CURVATURE_UNCERTAINTY_STEEL_BOLTED_CONNECTION_A_RESULTS.xlsx', index=False)
#------------------------------------------------------------------------------------------------  
# ------------------------------------------
