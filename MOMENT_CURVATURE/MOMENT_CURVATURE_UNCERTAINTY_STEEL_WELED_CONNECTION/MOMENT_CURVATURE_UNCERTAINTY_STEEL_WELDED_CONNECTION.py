...
def MOMENT_CURVATURE(secTag):
    ...
    ops.uniaxialMaterial('HystereticSM', MatTag, '-posEnv', *KP.flatten(), '-negEnv', *KN.flatten(), '-pinch', 1, 1,'-damage', 0.1, 0.01, '-beta', 0,'-defoLimitStates', ey, -ey, esu, -esu, '-forceLimitStates', fy, -fy, fu, -fu)#,'printInput'
