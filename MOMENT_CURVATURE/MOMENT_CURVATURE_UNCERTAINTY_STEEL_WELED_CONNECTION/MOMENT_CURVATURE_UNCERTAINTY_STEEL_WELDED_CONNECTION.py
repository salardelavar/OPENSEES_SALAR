...
def MOMENT_CURVATURE(secTag):
    ...
    Esh = (fu - fy) / (esu - ey)
    b = Esh / E
    kh = np.array([[ey, fy], [esu, fu], [1.1*esu, 0.2*fu], [1.2*esu, 0.1*fu]])# k horizontal
    ...
    # Set some parameters
    t = 10    #random.uniform(8, 11)     # [mm] Weld Thickness
    tf = 20   #random.uniform(18, 22)    # [mm] I Section Flange Thickness
    tw = 25   #random.uniform(18, 22)    # [mm] I Section Web Thickness
    bf = 220  #random.uniform(395, 405)  # [mm] I Section Flange Length
    H = 540   #random.uniform(595, 605)  # [mm] I Section Total Height
