...
NUM_SIM = 100                                  # Total number for simulation
#------------------------------------------------------------------------------------------------
...
S01.HISROGRAM_BOXPLOT(esu, HISTO_COLOR='cyan', LABEL='Ultimate Displacement [m]')
...
for i in range(NUM_SIM):
    time, displacement, velocity, acceleration, base_reaction, DI = ANALYSIS_SDOF(i)
