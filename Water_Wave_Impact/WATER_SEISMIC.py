...
while stable == 0 and current_time < duration:
    ...
    base_reaction_x.append(-ops.eleResponse(1, 'force')[0])  # Reaction force in x-direction
    base_reaction_y.append(-ops.eleResponse(1, 'force')[1])  # Reaction force in y-direction
