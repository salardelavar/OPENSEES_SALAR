...
def MOMENT_CURVATURE(secTag):
    ...
    # Define materials for nonlinear bolted seel connection
    # ------------------------------------------------------
    # STEEL MATERIALS
    # Bolt reinforcing steel
    fy = random.uniform(3850, 4150)    # Yield stress for bolt
    ey = random.uniform(0.018, 0.022)  # Yield strain for bolt
    esu = random.uniform(0.1, 0.12)    # Ultimate strain for bolt
    fu = 1.5 * fy                      # Ultimate stress for bolt
    ...
    # Plate reinforcing steel (Class 10.9)
    fyP = random.uniform(890, 905)           # Yield stress for plate
    eyP = random.uniform(0.00445, 0.004525)  # Yield strain for plate
    ...
    RZD = random.uniform(28, 32)          # Bolt Size Diameter
