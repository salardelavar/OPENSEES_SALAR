...
ops.recorder('Node', '-file', "BTH_PUSH_01.txt",'-time', '-node', 1, '-dof', 1,2, 'reaction') # Base Reaction Time History Node 1
ops.recorder('Node', '-file', "BTH_PUSH_02.txt",'-time', '-node', 2, '-dof', 1,2, 'reaction') # Base Reaction Time History Node 2
