...
from CONCRETE_SECTION import R_RECTANGULAR_CONCRETE_SECTION_REBAR_FF
...
fy = 0.4               # [kN/mm^2] Yield strength of steel rebar
fu = 1.5 * fy          # [kN/mm^2] Ultimate strength of steel rebar
Es = 200               # [kN/mm^2] Modulus of elasticity of steel rebar
...
epsc0 = -0.0025        # Strain at peak compressive strength
E0 = fcp / epsc0
...
COVER = 25    # [mm] Cover of the rectangular section
...
def TEMP_ANAL(B, H, COVER, RD, NUM_B, NUM_H, NUM_LAYERS):
    ...
    Depth = R_RECTANGULAR_CONCRETE_SECTION_REBAR_FF(secTag, B, H, COVER, RD, NUM_B, NUM_H, NUM_LAYERS,matTag02, matTag01, NO_PLOT=False)
...
# Plot frame shapes
PLOT_FRAME(deformed_scale=90)  # Adjust scale factor as needed
