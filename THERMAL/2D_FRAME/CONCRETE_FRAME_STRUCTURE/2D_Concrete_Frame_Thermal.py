...
Depth01 = R_RECTANGULAR_CONCRETE_SECTION_REBAR_B(secTag01, B, H, COVER, RD, NUM_B, NUM_H, NUM_LAYERS, matTag02, matTag01, PLOT=True)
# COLUMNS SECTION
...
Depth02 = R_RECTANGULAR_CONCRETE_SECTION_REBAR_C(secTag02, B, B, COVER, RD, NUM_B, NUM_H, NUM_LAYERS, NUM_FIRST, matTag02, matTag01, PLOT=True)
...
#ops.recorder('Element', '-file', 'STRESS_STRAIN_BOT_CONCRETE.txt', '-time', '-ele', 6, 'section', secTag01, 'fiber', -DD, 0, 'stressStrainTangent')
#ops.recorder('Element', '-file', 'STRESS_STRAIN_TOP_CONCRETE.txt', '-time', '-ele', 6, 'section', secTag, 'fiber', +DD, 0, 'stressStrainTangent')
ops.recorder('Element', '-file', 'STRESS_STRAIN_BOT_CONCRETE.txt', '-time', '-ele', 6, 'section', secTag01, 'fiber', -DD, 0, 'stressStrain')
ops.recorder('Element', '-file', 'STRESS_STRAIN_TOP_CONCRETE.txt', '-time', '-ele', 6, 'section', secTag01, 'fiber', +DD, 0, 'stressStrain')
ops.recorder('Element', '-file', 'STRESS_STRAIN_BOT_REBAR.txt', '-time', '-ele', 6, 'section', secTag01, 'fiber', -DD+COVER, -0.5*B+COVER, 'stressStrain')
ops.recorder('Element', '-file', 'STRESS_STRAIN_TOP_REBAR.txt', '-time', '-ele', 6, 'section', secTag01, 'fiber', +DD-COVER, -0.5*B+COVER, 'stressStrain')
#--------------------------------------------------------------------
# Perform analysis
temp = []
dispX = []
