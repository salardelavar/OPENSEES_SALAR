...
def R_RECTANGULAR_CONCRETE_SECTION_REBAR_SS(secTag, B, H, COVER, RD, NUM_B, NUM_H, matTag_concrete, matTag_steel):
    ...
    rebar_area = 3.14159 * (RD / 2) ** 2  # Calculate rebar cross-sectional area
    ...
    rebar_positions = [
        ...
        -H / 2 + 7 * H / 8,  # Sixth layer
    ]

    for y_loc in rebar_positions:
        x_loc_1 = -COVER  # First rebar in the layer
        x_loc_2 = COVER   # Second rebar in the layer
...
#-----------------------------------------------------------
def R_RECTANGULAR_CONCRETE_SECTION_REBAR_FF(secTag, B, H, COVER, RD, NUM_B, NUM_H, NUM_LAYERS, matTag_concrete, matTag_steel):
    # Define the concrete section using fibers
    ops.section('FiberThermal', secTag)
...
Depth = R_RECTANGULAR_CONCRETE_SECTION_REBAR_FF(secTag, B, H, COVER, RD, NUM_B, NUM_H, NUM_LAYERS,matTag02, matTag01)
#Depth = R_RECTANGULAR_CONCRETE_SECTION_REBAR_SS(secTag, B, H, COVER, RD, NUM_B, NUM_H, matTag02, matTag01)
...
ops.numberer('Plain')
ops.test('NormDispIncr', TOLERANCE, MAX_ITERATIONS, 2) # INFO LINK: https://openseespydoc.readthedocs.io/en/latest/src/normDispIncr.html
