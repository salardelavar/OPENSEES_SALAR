...
#---------------------------------------------- 
def R_RECTANGULAR_CONCRETE_SECTION_REBAR(secTag, B, H, COVER, RD, NUM_B, NUM_H, matTag_concrete, matTag_steel):
...
def PLOT_RECTANGULAR_CONCRETE_SECTION(B, H, COVER, RD, NUM_B, NUM_H):
    import matplotlib.pyplot as plt
    import numpy as np
...
# Concrete Thermal Fiber Section with Rebars 
Depth = R_RECTANGULAR_CONCRETE_SECTION_REBAR(secTag, B, H, COVER, RD, NUM_B, NUM_H, matTag02, matTag01)
PLOT_RECTANGULAR_CONCRETE_SECTION(B, H, COVER, RD, NUM_B, NUM_H)
#--------------------------------------------------------------------
