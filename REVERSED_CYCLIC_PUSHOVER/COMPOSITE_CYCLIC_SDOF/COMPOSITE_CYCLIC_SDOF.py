...
#            REVERSED CYCLIC PUSHOVER ANALYSIS OF SINGLE DEGREE OF FREEDOM (SDOF)                         #
#            REINFORCED CONCRETE SECTION WITH PLATES EVALUATING STRAIN HARDENING                          #
#                       AND ULTIMATE STRAIN CRITERIA USING OPENSEES                                       #
#---------------------------------------------------------------------------------------------------------#
