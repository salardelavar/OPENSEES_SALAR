...
EYx = 5.1     # [mm] Yield displacement in X direction
FUx = 150e4   # [N] Ultimate force in X direction
EUx = 50.5    # [mm] Ultimate displacement in X direction
# FRACTION DAMPER IN Y DIRECTION
FYy = 602e3   # [N] Yield force in Y direction
EYy = 1.5     # [mm] Yield displacement in Y direction
FUy = 762e3   # [N] Ultimate force in Y direction
EUy = 10.3    # [mm] Ultimate displacement in Y direction
...
def CYCLIC_ANALYSIS(LENGTH_COL, LENGTH_BM, CYCL, NUM, STEEL_KIND):
    ...
    #ops.element('corotTruss', 6, 2, 5, secTagBR) 
    ops.element('corotTruss', 5, 1, 5, 2256.0, steelTag)
    ops.element('corotTruss', 6, 2, 5, 2256.0, steelTag)                                 # BRACE 02
...
#%%------------------------------------------------------------------------------
# Force-Displacement Curve for Stiffness Spring - Hysteretic Uniaxial Material
...
plt.plot(displacementsY, forcesY, 'red', label="Hysteretic Model in Y Dir.", markersize=4)
