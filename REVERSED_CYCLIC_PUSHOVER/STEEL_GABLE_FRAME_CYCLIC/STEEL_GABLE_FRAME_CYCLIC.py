...
MAX_VALUE = 2     # [mm] MAXIMUM DISPLACEMENT VALUE
...
def CYCLIC_ANALYSIS(LENGTH_COL, LENGTH_BM, CYCL, NUM, STEEL_KIND):
    ...
    # STEEL I SECTION
    d, MASS = S03.STEEL_I_SECTION_QUAD(secTagB, steelTag, bf=220, tf=10, hw=180, tw=10, PLOT=True, DENSITY=7850/1e9)
    d, MASS = S03.STEEL_I_SECTION_QUAD(secTagC, steelTag, bf=220, tf=10, hw=280, tw=10, PLOT=True, DENSITY=7850/1e9)
...
results_df.to_excel('STEEL_GABLE_FRAME_CYCLIC_RESULTS.xlsx', index=False) 
