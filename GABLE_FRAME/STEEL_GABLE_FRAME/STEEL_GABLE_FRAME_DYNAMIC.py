...
def DYNAMIC_ANALYSIS(hw_COL, tw_COL,tf_COL, bf_COL, hw_BEAM, tw_BEAM, tf_BEAM, bf_BEAM, H1, H2, L1, N, ND, Weight, UL, Damping_Ratio, dt, Duration, ELE_KIND):
    ...
    print('Dynamic Done.\n')
    #op.wipe()
    return TIME, drift, displacements_x, displacements_y, rotations, velocityX, accelerationX, velocityY, accelerationY, base_shears, base_axials, base_moments, PERIOD_01, PERIOD_02
...
TIME, drift, displacements_x, displacements_y, rotations, velocityX, accelerationX, velocityY, accelerationY, base_shears, base_axials, base_moments, PERIOD_01, PERIOD_02 = DATAd
