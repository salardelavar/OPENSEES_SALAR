...
#%%-----------------------------------------------------------------------------------
image_path = 'PROGRESSIVE_COLLAPSE_CONCRETE_FRAME_01.png'    
PLOT_IMAGE(image_path)
#%%-----------------------------------------------------------------------------------
image_path = 'PROGRESSIVE_COLLAPSE_CONCRETE_FRAME_02.jpg'    
PLOT_IMAGE(image_path)
#%%-----------------------------------------------------------------------------------
def CURRENT_TIME():
    import time
...
DATA_TOTAL = {
    ...
    'COL-03-AXIAL': A_col02,
    'COL-03-SHEAR': S_col02,
    'COL-03-MOMENT': M_col02,
    'COL-05-AXIAL': A_col03,
    'COL-05-SHEAR': S_col03,
    'COL-05-MOMENT': M_col03,
}
