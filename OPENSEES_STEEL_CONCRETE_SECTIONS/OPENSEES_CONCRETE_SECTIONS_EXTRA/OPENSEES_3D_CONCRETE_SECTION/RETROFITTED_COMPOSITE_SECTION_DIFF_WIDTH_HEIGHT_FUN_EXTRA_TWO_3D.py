def RETROFITTED_COMPOSITE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_TWO_3D(secTag, STEEL_TYPE, fc, Kfc, CONCRETE_DENSITY, plot=True):
    """
    ...
    mat_layers = [
        ...
        (PT, 100.0+PT, CD+0.5*PT, CW-50.0+0.5*PT, NFY, NFX, steelITag, 'cyan'),             # 50 -> PLATE
        (PT, 100.0+PT, 0.0-0.5*PT, 0.5*100.0-0.5*PT, NFY, NFX, steelITag, 'cyan'),          # 51 -> PLATE
        (100.0, PT, CD-50.0, CW+0.5*PT, NFY, NFX, steelITag, 'cyan'),                       # 51 -> PLATE   
        (100.0, PT, 0.5*100.0, -0.5*PT, NFY, NFX, steelITag, 'cyan'),                       # 52 -> PLATE
        
        (PT, 100.0+PT, CD+0.5*PT, 50.0-0.5*PT, NFY, NFX, steelITag, 'cyan'),                # 53 -> PLATE
        (PT, 100.0+PT, 0.0-0.5*PT, CW-50.0+0.5*PT, NFY, NFX, steelITag, 'cyan'),            # 54 -> PLATE
        (100.0, PT, CD-50.0, 0.0-0.5*PT, NFY, NFX, steelITag, 'cyan'),                      # 55 -> PLATE   
        (100.0, PT, 50.0, CW+0.5*PT, NFY, NFX, steelITag, 'cyan'),                          # 56 -> PLATE
        
        (PT, CW-100.0, CD+1.5*PT, 0.5*CW, NFY, NFX, steelITag, 'cyan'),                     # 57 -> PLATE
        (PT, CW-100.0, 0.0-1.5*PT, 0.5*CW, NFY, NFX, steelITag, 'cyan'),                    # 58 -> PLATE
        (CD-100.0, PT, 0.5*CD, CW+1.5*PT, NFY, NFX, steelITag, 'cyan'),                     # 59 -> PLATE   
        (CD-100.0, PT, 0.5*CD, -1.5*PT, NFY, NFX, steelITag, 'cyan'),                       # 60 -> PLATE
        # STEEL SECTION
        (10.0, 150.0, 0.5*CD-125.0, 0.5*CW, NFY, NFX, steelITag, 'lime'),                  # 61 -> CROSSED SECTION
        (240.0, 10.0, 0.5*CD, 0.5*CW, NFY, NFX, steelITag, 'lime'),                        # 62 -> CROSSED SECTION
        (10.0, 150.0, 0.5*CD+125.0, 0.5*CW, NFY, NFX, steelITag, 'lime'),                  # 63 -> CROSSED SECTION   
         
        (10.0, 105.0, 0.5*CD, 0.5*CW-57.5, NFY, NFX, steelITag, 'lime'),                   # 64 -> CROSSED SECTION
        (10.0, 105.0, 0.5*CD, 0.5*CW+57.5, NFY, NFX, steelITag, 'lime'),                   # 65 -> CROSSED SECTION
        
        (150.0, 10.0, 0.5*CD, 0.5*CW-115.0, NFY, NFX, steelITag, 'lime'),                  # 66 -> CROSSED SECTION
        (150.0, 10.0, 0.5*CD, 0.5*CW+115.0, NFY, NFX, steelITag, 'lime'),                  # 67 -> CROSSED SECTION
    ]
