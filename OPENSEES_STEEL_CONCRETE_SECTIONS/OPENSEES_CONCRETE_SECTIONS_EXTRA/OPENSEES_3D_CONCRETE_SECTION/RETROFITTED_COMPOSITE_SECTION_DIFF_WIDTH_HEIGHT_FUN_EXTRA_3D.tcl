# RETROFITTED_COMPOSITE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D
...
proc RETROFITTED_COMPOSITE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D {secTag STEEL_TYPE fc Kfc CONCRETE_DENSITY} {
    # ------------------------------------------------------------------
...
#set result [RETROFITTED_COMPOSITE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D $secTag $steelType $fc $Kfc $density]
