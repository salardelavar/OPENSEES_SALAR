# COMPOSITE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D
...
proc CompositeSectionDiffWidthHeightFunExtra3D {secTag STEEL_TYPE fc Kfc CONCRETE_DENSITY} {
    # ------------------------------------------------------------------
    #  Material properties
    # ------------------------------------------------------------------
    # Concrete (units: mm, N)
...
#set result [CompositeSectionDiffWidthHeightFunExtra3D $secTag $steelType $fc $Kfc $density]
