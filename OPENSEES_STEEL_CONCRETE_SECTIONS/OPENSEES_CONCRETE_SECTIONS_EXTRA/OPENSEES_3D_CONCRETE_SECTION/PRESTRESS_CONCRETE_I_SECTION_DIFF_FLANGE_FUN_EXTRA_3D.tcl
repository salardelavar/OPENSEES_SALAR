# PRESTRESS_CONCRETE_I_SECTION_DIFF_FLANGE_FUN_3D
...
proc PRESTRESS_CONCRETE_I_SECTION_DIFF_FLANGE_FUN_3D {secTag matTag STEEL_TYPE fc Kfc bfT tfT bfB tfB h tw nFib CONCRETE_DENSITY} {
    # ------------------------------------------------------------------
...
#set result [PRESTRESS_CONCRETE_I_SECTION_DIFF_FLANGE_FUN_3D $secTag $matTag $steelType $fc $Kfc $bfT $tfT $bfB $tfB $h $tw $nFib $density]
