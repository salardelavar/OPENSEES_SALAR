def CONCRETE_SHEAR_WALL_U_SHAPE_SECTION_EXTRA_FUN_3D(secTag, STEEL_TYPE, fc, Kfc, CONCRETE_DENSITY, plot=True):
    """
    Create a concrete U-Shape shear wall with different widths and heights, fiber section (OpenSees) and,
    ...
    concrete_layers = [
        (4000.0, 300.0, 2000, 150.0, NFY, NFX, coreTag, 'lightgray'),            # 1
        (300.0, 5000.0, 150.0, 300.0+2500.0, NFY, NFX, coreTag, 'lightgray'),    # 2
        (4000.0, 300.0, 2000, 5000.0+450.0, NFY, NFX, coreTag, 'lightgray'),     # 3
    ...
    rebars = [
        ...
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+0*150.0),      # 53 -> SHEAR WALL 02 - DISTANCE 150.0 mm
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+0*150.0),      # 54
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+1*150.0),      # 55
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+1*150.0),      # 56
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+2*150.0),      # 57
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+2*150.0),      # 58
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+3*150.0),      # 59
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+3*150.0),      # 60
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+4*150.0),      # 61
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+4*150.0),      # 62
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+5*150.0),      # 63
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+5*150.0),      # 64
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+6*150.0),      # 65
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+6*150.0),      # 66
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+7*150.0),      # 67
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+7*150.0),      # 68
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+8*150.0),      # 69
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+8*150.0),      # 70
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+9*150.0),      # 71
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+9*150.0),      # 72
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+10*150.0),      # 73
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+10*150.0),      # 74
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+11*150.0),      # 75
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+11*150.0),      # 76
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+12*150.0),      # 77
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+12*150.0),      # 78
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+13*150.0),      # 79
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+13*150.0),      # 80
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+14*150.0),      # 81
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+14*150.0),      # 82
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+15*150.0),      # 83
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+15*150.0),      # 84
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+16*150.0),      # 85
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+16*150.0),      # 86
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+17*150.0),      # 87
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+17*150.0),      # 88
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+18*150.0),      # 89
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+18*150.0),      # 90
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+19*150.0),      # 91
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+19*150.0),      # 92
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+20*150.0),      # 93
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+20*150.0),      # 94
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+21*150.0),      # 95
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+21*150.0),      # 96
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+22*150.0),      # 97
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+22*150.0),      # 98
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+23*150.0),      # 99
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+23*150.0),      # 100
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+24*150.0),      # 101
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+24*150.0),      # 102
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+25*150.0),      # 103
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+25*150.0),      # 104
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+26*150.0),      # 105
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+26*150.0),      # 106
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+27*150.0),      # 107
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+27*150.0),      # 108
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+28*150.0),      # 109
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+28*150.0),      # 110
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+29*150.0),      # 111
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+29*150.0),      # 112
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+30*150.0),      # 113
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+30*150.0),      # 114
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+31*150.0),      # 115
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+31*150.0),      # 116
        (RD,  150.0-0.5*300.0+50.0, 300.0+100.0+32*150.0),      # 117
        (RD,  150.0+0.5*300.0-50.0, 300.0+100.0+32*150.0),      # 118
    ...
    if plot:
        ...
        ax.set_title('U-shape Shear-wall Concrete section (Numbers shown) with rebars')
