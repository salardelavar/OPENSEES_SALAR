def COMPOSITE_REC_I_SECTION_FUN_EXTRA_3D(secTag, HSec, BSec, cover,
                              STEEL_TYPE, fc, Kc,
                              bf, tf, h, tw,
                              STEEL_DENSITY,
    ...
    eyI = fy/Es        # [mm/mm] Steel I Section Yield Strain
    fuI = 1.1818*fy    # [N/mm²] Steel I Section Ultimate Strength
    ...
    if STEEL_TYPE == 'ELASTIC':
        ...
        ops.uniaxialMaterial('Steel01', steelITag, fyI, EsI, BsI) # I SECION
    ...
    ops.section('Fiber', secTag, '-GJ', 1.0e12)
    ...
    rebars = [
        ...
        (14.0,  0.0, -BSec/2 + cover),                # 9
        (14.0,  0.0, +BSec/2 - cover),                # 10
    ]
    ...
    if PLOT:
        ...
        ax.set_title(f'Confined Concrete Section with I Section– tag {secTag}')
