def CONCRETE_SHEAR_WALL_L_SHAPE_SECTION_EXTRA_FUN_3D(secTag, STEEL_TYPE, fc, Kfc, CONCRETE_DENSITY, plot=True):
    """
    Create a concrete L-Shape shear wall with different widths and heights, fiber section (OpenSees) and,
    ...
    if plot:
        ...
        ax.set_title('L-shape Shear-wall Concrete section (Numbers shown) with rebars')
