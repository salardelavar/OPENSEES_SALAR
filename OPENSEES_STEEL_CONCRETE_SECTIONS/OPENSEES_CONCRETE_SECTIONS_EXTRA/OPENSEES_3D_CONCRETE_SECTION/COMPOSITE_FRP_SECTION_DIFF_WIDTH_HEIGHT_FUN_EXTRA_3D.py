def COMPOSITE_FRP_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D(secTag, STEEL_TYPE, fc, Kfc, CONCRETE_DENSITY, plot=True):
    """
    ...
    mat_layers = [
        ...
        (10.0, 150.0, 0.5*CD+125, 0.5*CW, NFY, NFX, steelITag, 'lime'),                    # 56 -> CROSSED SECTION   
