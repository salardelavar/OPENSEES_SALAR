# COMPOSITE_REC_CROSS_SHAPED_STEEL_SECTION_FUN_EXTRA_3D
...
proc COMPOSITE_REC_CROSS_SHAPED_STEEL_SECTION_FUN_EXTRA_3D {secTag HSec BSec cover STEEL_TYPE fc Kc STEEL_DENSITY CONCRETE_DENSITY PLOT} {
    # ------------------------------------------------------------------
    #  Geometry parameters
    # ------------------------------------------------------------------
...
#set result [COMPOSITE_REC_CROSS_SHAPED_STEEL_SECTION_FUN_EXTRA_3D $secTag $HSec $BSec $cover $steelType $fc $Kc $steelDensity $concreteDensity $plotFlag]
