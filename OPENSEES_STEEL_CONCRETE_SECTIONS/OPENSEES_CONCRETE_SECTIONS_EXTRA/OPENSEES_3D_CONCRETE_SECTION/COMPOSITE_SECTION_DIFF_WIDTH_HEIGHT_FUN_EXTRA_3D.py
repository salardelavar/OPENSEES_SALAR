def COMPOSITE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D(secTag, STEEL_TYPE, fc, Kfc, CONCRETE_DENSITY, plot=True):
    """
    ...
    mat_layers = [
        ...
        (PT, 500.0+2*PT, 500.0+0.5*PT, 0.5*500.0, NFY, NFX, steelITag, 'cyan'),           # 50 -> PLATE
        (PT, 500.0+2*PT, 0.0-0.5*PT, 0.5*500.0, NFY, NFX, steelITag, 'cyan'),             # 51 -> PLATE
        (500.0, PT, 0.5*500.0, 500.0+0.5*PT, NFY, NFX, steelITag, 'cyan'),                # 52 -> PLATE   
        (500.0, PT, 0.5*500.0, -0.5*PT, NFY, NFX, steelITag, 'cyan'),                     # 53 -> PLATE

        (10.0, 150.0, 250.0-125.0, 250.0, NFY, NFX, steelITag, 'lime'),                  # 54 -> CROSSED SECTION
        (240.0, 10.0, 250.0, 250.0, NFY, NFX, steelITag, 'lime'),                        # 55 -> CROSSED SECTION
        (10.0, 150.0, 250+125.0, 250.0, NFY, NFX, steelITag, 'lime'),                    # 56 -> CROSSED SECTION   
         
        (10.0, 105.0, 250.0, 250.0-57.5, NFY, NFX, steelITag, 'lime'),                   # 57 -> CROSSED SECTION
        (10.0, 105.0, 250.0, 250.0+57.5, NFY, NFX, steelITag, 'lime'),                   # 58 -> CROSSED SECTION
        
        (150.0, 10.0, 250.0, 250.0-115.0, NFY, NFX, steelITag, 'lime'),                  # 59 -> CROSSED SECTION
        (150.0, 10.0, 250.0, 250.0+115.0, NFY, NFX, steelITag, 'lime'),                  # 60 -> CROSSED SECTION 
    ]
    ...
    if plot:
        ...
        ax.set_title(f'Composite section with rebars and plates (Numbers shown) - Section Tag: {secTag}')
