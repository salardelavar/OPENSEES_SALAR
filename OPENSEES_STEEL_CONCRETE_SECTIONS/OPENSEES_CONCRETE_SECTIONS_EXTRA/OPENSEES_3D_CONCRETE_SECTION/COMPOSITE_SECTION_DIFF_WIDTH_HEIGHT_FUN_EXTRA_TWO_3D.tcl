proc COMPOSITE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_TWO_3D {secTag STEEL_TYPE fc Kfc CONCRETE_DENSITY} {
...
#set result [COMPOSITE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_TWO_3D 1 "INELASTIC" -30.0 1.2 2400.0]
