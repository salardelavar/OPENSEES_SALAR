...
proc CONCRETE_REC_SECTION_FUN_3D {secTag STEEL_TYPE fc Kfc Bsec Hsec cover nFib CONCRETE_DENSITY} {
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    section Fiber $secTag -GJ 1.0e12
...
#set result [CONCRETE_REC_SECTION_FUN_3D $secTag $STEEL_TYPE $fc $Kfc $Bsec $Hsec $cover $nFib $density]
