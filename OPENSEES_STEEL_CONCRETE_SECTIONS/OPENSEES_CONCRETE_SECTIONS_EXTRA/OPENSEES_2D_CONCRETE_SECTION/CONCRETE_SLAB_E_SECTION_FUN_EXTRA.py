def CONCRETE_SLAB_E_SECTION_FUN(secTag, STEEL_TYPE, fc, Kfc,
                           Bsec, Hsec, cover,
    ...
    rebars = [
        ...
        (REBAR_DIA,  -cover, -BW/2 + cover),             # 86 
        (REBAR_DIA,  -cover, -BW/2 + cover + 1*DIST),    # 87
        # LAYER 05
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover),           # 88
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 1*DIST),  # 89
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover),           # 90
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 1*DIST),  # 91
        (REBAR_DIA,  -Hsec/2 + cover, -BW/2 + cover),             # 92 
        (REBAR_DIA,  -Hsec/2 + cover, -BW/2 + cover + 1*DIST),    # 93     
    ]
