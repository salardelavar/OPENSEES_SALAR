# CONCRETE_SHEAR_WALL_SECTION_FUN_EXTRA_EXTRA
...
proc CONCRETE_SHEAR_WALL_SECTION_FUN_EXTRA_EXTRA {secTag STEEL_TYPE fc Kfc Bsec Hsec cover nFib CONCRETE_DENSITY} {
    # ------------------------------------------------------------------
...
#set result [CONCRETE_SHEAR_WALL_SECTION_FUN_EXTRA $secTag $steelType $fc $Kfc $Bsec $Hsec $cover $nFib $density]
