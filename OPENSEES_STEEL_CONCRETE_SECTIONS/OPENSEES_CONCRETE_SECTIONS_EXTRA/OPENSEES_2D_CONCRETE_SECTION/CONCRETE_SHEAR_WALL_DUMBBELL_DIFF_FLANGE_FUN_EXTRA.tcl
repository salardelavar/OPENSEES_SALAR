# CONCRETE_DUMBBELL_SHEAR_WALL_DIFF_FLANGE_FUN_EXTRA
...
proc CONCRETE_DUMBBELL_SHEAR_WALL_DIFF_FLANGE_FUN_EXTRA {secTag STEEL_TYPE fc Kfc bfT tfT bfB tfB h tw nFib CONCRETE_DENSITY} {
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    #  Fiber section definition (no GJ)
    # ------------------------------------------------------------------
...
#set result [CONCRETE_DUMBBELL_SHEAR_WALL_DIFF_FLANGE_FUN_EXTRA $secTag $steelType $fc $Kfc $bfT $tfT $bfB $tfB $h $tw $nFib $density]
