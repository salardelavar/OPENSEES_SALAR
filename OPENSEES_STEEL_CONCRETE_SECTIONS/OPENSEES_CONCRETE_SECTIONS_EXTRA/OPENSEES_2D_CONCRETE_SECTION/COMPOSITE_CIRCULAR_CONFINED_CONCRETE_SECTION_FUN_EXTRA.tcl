proc COMPOSITE_CIRCULAR_CONFINED_CONCRETE_SECTION_FUN_EXTRA {secTag RI RO COVER fc Kfc THICKNESS STEEL_TYPE STEEL_DENSITY CONCRETE_DENSITY} {
    # ----------------------------------------------------------------------
...
#set result [COMPOSITE_CIRCULAR_CONFINED_CONCRETE_SECTION_FUN_EXTRA $secTag $RI $RO $COVER $fc $Kfc $THICKNESS $STEEL_TYPE $STEEL_DENSITY $CONCRETE_DENSITY]
