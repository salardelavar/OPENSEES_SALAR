...
proc CONCRETE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA {secTag STEEL_TYPE fc Kfc CONCRETE_DENSITY} {
    # ------------------------------------------------------------------
    #  Material properties
    # ------------------------------------------------------------------
    # Concrete (units: mm, N)
...
#set result [CONCRETE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA $secTag $steelType $fc $Kfc $density]
