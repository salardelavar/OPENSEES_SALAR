...
section_tag = 1
"""
def CONCRETE_I_SECTION_DIFF_FLANGE_FUN(secTag, STEEL_TYPE, fc, Kfc,
                           bfT, tfT, bfB, tfB, h, tw,
                           nFib, CONCRETE_DENSITY,
                           plot=True):
    """
    Create a I confined‑concrete with different flanges width, fiber section (OpenSees) and,
    ...
    rebars = [
        (25.0,  h - tfT/2, -bfT/3),   # 1
        (25.0,  h - tfT/2,  bfT/3),   # 2
        (25.0,  h - tfT/2, -bfT/6),   # 3
        (25.0,  h - tfT/2, bfT/6),    # 4
        (25.0, h - tfT/2, -bfT/20),   # 5
        (25.0, h - tfT/2,  bfT/20),   # 6
        (18.0,  tfB+hw*0.2, -tw/4),   # 7
        (18.0,  tfB+hw*0.2,  tw/4),   # 8
        (18.0,  tfB+hw*0.4, -tw/4),   # 9
        (18.0,  tfB+hw*0.4,  tw/4),   # 10
        (18.0,  tfB+hw*0.6, -tw/4),   # 11
        (18.0,  tfB+hw*0.6,  tw/4),   # 12
        (18.0,  tfB+hw*0.8, -tw/4),   # 13
        (18.0,  tfB+hw*0.8,  tw/4),   # 14
        (25.0, 1*tfB/3, -bfB/3 + 0.05*bfB),  # 15
        (25.0, 1*tfB/3,  bfB/3 - 0.05*bfB),  # 16
        (25.0,  1*tfB/3, -bfB/3 + 0.20*bfB), # 17
        (25.0,  1*tfB/3,  bfB/3 - 0.20*bfB), # 18
        (25.0, 2*tfB/3, -bfB/3 + 0.05*bfB),  # 19
        (25.0, 2*tfB/3,  bfB/3 - 0.05*bfB),  # 20
        (25.0,  2*tfB/3, -bfB/3 + 0.20*bfB), # 21
        (25.0,  2*tfB/3,  bfB/3 - 0.20*bfB), # 22
    ]
    ...
    if plot:
        ...
        ax.set_title('I Section Different flange with Rebars (numbers shown)')
