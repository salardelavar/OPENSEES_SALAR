def CONCRETE_SLAB_U_SECTION_FUN(secTag, STEEL_TYPE, fc, Kfc,
                           Bsec, Hsec, cover,
                           nFib, CONCRETE_DENSITY,
                           plot=True):
    """
    Create a U Section confined‑concrete fiber section (OpenSees).
    ...
    rebars = [
        ...
        # LAYER 05
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover),           # 86
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 1*DIST),  # 87
