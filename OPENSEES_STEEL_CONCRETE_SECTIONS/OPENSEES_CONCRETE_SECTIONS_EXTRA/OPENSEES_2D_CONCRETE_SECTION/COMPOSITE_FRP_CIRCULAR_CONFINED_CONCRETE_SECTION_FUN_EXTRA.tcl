# ==============================================================================
# COMPOSITE_FRP_CIRCULAR_CONFINED_CONCRETE_SECTION_FUN_EXTRA
...
proc COMPOSITE_FRP_CIRCULAR_CONFINED_CONCRETE_SECTION_FUN_EXTRA {secTag RI RO COVER fc Kfc THICKNESS STEEL_TYPE STEEL_DENSITY CONCRETE_DENSITY} {
    # --------------------------------------------------------------------------
...
#COMPOSITE_FRP_CIRCULAR_CONFINED_CONCRETE_SECTION_FUN_EXTRA $secTag $RI $RO $COVER $fc $Kfc $THICKNESS $STEEL_TYPE $STEEL_DENSITY $CONCRETE_DENSITY
