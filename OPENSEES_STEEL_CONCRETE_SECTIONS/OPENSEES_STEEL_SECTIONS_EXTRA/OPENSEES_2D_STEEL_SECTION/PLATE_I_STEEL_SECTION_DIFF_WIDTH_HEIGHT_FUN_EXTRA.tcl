# PLATE_I_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA
...
proc PLATE_I_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA {secTag STEEL_TYPE STEEL_DENSITY} {
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    #  Fiber section definition (no GJ specified, same as original)
    # ------------------------------------------------------------------
...
set result [PLATE_I_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA $secTag $steelType $density]
