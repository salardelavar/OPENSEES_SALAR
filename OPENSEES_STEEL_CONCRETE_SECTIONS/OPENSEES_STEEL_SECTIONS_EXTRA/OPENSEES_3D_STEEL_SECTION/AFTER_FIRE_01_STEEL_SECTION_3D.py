def AFTER_FIRE_01_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_TWO_3D(secTag, STEEL_TYPE, fc, Kfc, CONCRETE_DENSITY, plot=True):
    """
    ...
    mat_layers = [
        # STEEL SECTION
        (10.0, 150.0, 0.5*CD-0.25*CD, 0.5*CW, NFY, NFX, steelITag01, 'lime'),                # 54 -> CROSSED SECTION
        (240.0, 10.0, 0.5*CD, 0.5*CW, NFY, NFX, steelITag01, 'lime'),                        # 55 -> CROSSED SECTION
        (10.0, 150.0, 0.5*CD+0.25*CD, 0.5*CW, NFY, NFX, steelITag01, 'lime'),                # 56 -> CROSSED SECTION   
         
        (10.0, 105.0, 0.5*CD, 0.5*CW-57.5, NFY, NFX, steelITag03, 'pink'),                   # 57 -> CROSSED SECTION
        (10.0, 105.0, 0.5*CD, 0.5*CW+57.5, NFY, NFX, steelITag02, 'cyan'),                   # 68 -> CROSSED SECTION
        
        (150.0, 10.0, 0.5*CD, 0.5*CW-115.0, NFY, NFX, steelITag03, 'pink'),                  # 59 -> CROSSED SECTION
        (150.0, 10.0, 0.5*CD, 0.5*CW+115.0, NFY, NFX, steelITag02, 'cyan'),                  # 60 -> CROSSED SECTION
    ]
