def STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D(secTag, STEEL_TYPE, STEEL_DENSITY, plot=True):
    """
    ...
    steel_layers = [
        ...
        (50.0, 90.0, 75.0, 350.0, 10, 10),    # 2
        (50.0, 80.0, 125.0, 350.0, 10, 10),   # 3
        (50.0, 70.0, 175.0, 350.0, 10, 10),   # 4
        (50.0, 60.0, 225.0, 350.0, 10, 10),   # 5
        (50.0, 50.0, 275.0, 350.0, 10, 10),   # 6
        (50.0, 50.0, 325.0, 350.0, 10, 10),   # 7
        (50.0, 50.0, 375.0, 350.0, 10, 10),   # 8
        (50.0, 50.0, 425.0, 350.0, 10, 10),   # 9
        (50.0, 50.0, 475.0, 350.0, 10, 10),   # 10
        (50.0, 50.0, 525.0, 350.0, 10, 10),   # 11
        (50.0, 50.0, 575.0, 350.0, 10, 10),   # 12 
        (50.0, 50.0, 625.0, 350.0, 10, 10),   # 13
        (50.0, 50.0, 675.0, 350.0, 10, 10),   # 14
        (50.0, 50.0, 725.0, 350.0, 10, 10),   # 15
        (50.0, 60.0, 775.0, 350.0, 10, 10),   # 16
        (50.0, 70.0, 825.0, 350.0, 10, 10),   # 17
        (50.0, 80.0, 875.0, 350.0, 10, 10),   # 18
        (50.0, 90.0, 925.0, 350.0, 10, 10),   # 19
    ...
    if plot:
        ...
        ax.set_title('Steel section (20 layers)')
