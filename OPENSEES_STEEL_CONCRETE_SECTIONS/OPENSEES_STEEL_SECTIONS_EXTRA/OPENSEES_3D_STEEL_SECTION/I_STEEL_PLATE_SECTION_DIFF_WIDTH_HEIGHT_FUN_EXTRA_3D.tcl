...
# ----------------------------------------------------------------------
proc I_STEEL_PLATE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D {secTag STEEL_TYPE STEEL_DENSITY} {
    # ------------------------------------------------------------------
...
#set result [I_STEEL_PLATE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D 1 "INELASTIC" 7850.0]
