# PLATE_I_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D
...
proc PLATE_I_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D {secTag STEEL_TYPE STEEL_DENSITY} {
    # ------------------------------------------------------------------
...
set result [PLATE_I_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D $secTag $steelType $density]
