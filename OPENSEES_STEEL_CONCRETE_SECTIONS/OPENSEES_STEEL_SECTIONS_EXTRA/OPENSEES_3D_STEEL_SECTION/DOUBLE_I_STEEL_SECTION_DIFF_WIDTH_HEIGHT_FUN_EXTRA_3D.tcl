# DOUBLE_I_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D
# Create a steel fiber section (OpenSees) with six rectangular patches.
...
#
# NOTE: The mass calculation follows the original Python code and is
#       dimensionally inconsistent (kg/m³ * mm² = kg·m⁻³·mm²). This is kept
#       for exact compatibility.
# THIS TCL SCRIPT WRITTEN BY SALAR DELAVAR GHASHGHAEI (QASHQAI)

proc DOUBLE_I_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D {secTag STEEL_TYPE STEEL_DENSITY} {
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    #  Fiber section definition (with GJ)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    set steel_layers {
        {10.0 100.0   5.0  50.0 10 10}
        {160.0 10.0  90.0  50.0 10 10}
        {10.0 100.0 175.0  50.0 10 10}
        {10.0 100.0   5.0 150.0 10 10}
        {160.0 10.0  90.0 150.0 10 10}
        {10.0 100.0 175.0 150.0 10 10}
    }
...
#set result [DOUBLE_I_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D $secTag $steelType $density]
