...
proc SteelCornerBoxSectionDiffWidthHeightFunExtra3D {secTag STEEL_TYPE STEEL_DENSITY} {
    # ------------------------------------------------------------------
...
#set result [SteelCornerBoxSectionDiffWidthHeightFunExtra3D $secTag $steelType $density]
