def AFTER_FIRE_03_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_TWO_3D(secTag, STEEL_TYPE, fc, Kfc, CONCRETE_DENSITY, plot=True):
    """
    ...
    mat_layers = [
        # STEEL SECTION
        (PT, ACD+PT, CD+0.5*PT, CD-0.5*ACD+0.5*PT, NFY, NFX, steelITag01, 'lime'),                    # 01 -> PLATE
        (PT, ACD+PT, 0.0-0.5*PT, 0.5*ACD-0.5*PT, NFY, NFX, steelITag03, 'pink'),                      # 02 -> PLATE
        (ACD, PT, CD-0.5*ACD, CD+0.5*PT, NFY, NFX, steelITag01, 'lime'),                              # 03 -> PLATE   
        (ACD, PT, 0.5*ACD, -0.5*PT, NFY, NFX, steelITag03, 'pink'),                                   # 04 -> PLATE
        
        (PT, ACD+PT, CD+0.5*PT, 50.0-0.5*PT, NFY, NFX, steelITag03, 'pink'),                          # 05 -> PLATE
        (PT, ACD+PT, 0.0-0.5*PT, CD-0.5*ACD+0.5*PT, NFY, NFX, steelITag01, 'lime'),                   # 06 -> PLATE
        (ACD, PT, CD-0.5*ACD, 0.0-0.5*PT, NFY, NFX, steelITag03, 'pink'),                             # 07 -> PLATE   
        (ACD, PT, 0.5*ACD, CD+0.5*PT, NFY, NFX, steelITag01, 'lime'),                                 # 08 -> PLATE
        
        (PT, CD-ACD, CD+1.5*PT, 0.5*CD, NFY, NFX, steelITag01, 'lime'),                               # 09 -> PLATE
        (PT, CD-ACD, 0.0-1.5*PT, 0.5*CD, NFY, NFX, steelITag03, 'pink'),                              # 10 -> PLATE
        (CD-ACD, PT, 0.5*CD, CD+1.5*PT, NFY, NFX, steelITag01, 'lime'),                               # 11 -> PLATE   
        (CD-ACD, PT, 0.5*CD, -1.5*PT, NFY, NFX, steelITag03, 'pink'),                                 # 12 -> PLATE
