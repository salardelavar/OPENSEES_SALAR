def STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D(secTag, STEEL_TYPE, STEEL_DENSITY, plot=True):
    ...
    steel_layers = [
        ...
        (10.0, 200.0, 175.0, 100.0, 10, 10),  # 3    
         
        (6.0, 70.0, -3.0, 100.0, 10, 10),     # 4
        (6.0, 150.0, 183.0, 100.0, 10, 10),   # 5
        
        (120.0, 8.0, 90.0, 91.0, 10, 10),     # 6
        (120.0, 8.0, 90.0, 109.0, 10, 10),    # 7
        
        (80.0, 8.0, 10.0, 46.0, 10, 10),      # 8
        (80.0, 8.0, 10.0, 154.0, 10, 10),     # 9
        
        (80.0, 8.0, 166.0, 4.0, 10, 10),      # 10
        (80.0, 8.0, 166.0, 196.0, 10, 10),    # 11
    ...
    if plot:
        ...
        ax.set_title('Steel section (11 layers)')
