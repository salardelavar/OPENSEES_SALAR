...
proc SteelBoxSectionDiffWidthHeightFunExtra3D {secTag STEEL_TYPE STEEL_DENSITY} {
    # ------------------------------------------------------------------
...
#set result [SteelBoxSectionDiffWidthHeightFunExtra3D $secTag $steelType $density]
