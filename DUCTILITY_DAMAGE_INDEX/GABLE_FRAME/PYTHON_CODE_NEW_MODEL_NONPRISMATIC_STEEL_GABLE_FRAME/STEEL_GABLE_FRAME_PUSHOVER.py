...
def PUSHOVER_ANALYSIS(hw_COL, tw_COL,tf_COL, bf_COL, hw_BEAM, tw_BEAM, tf_BEAM, bf_BEAM, H1, H2, L1, N, ND, Weight, UL, Dincr, DMAX, ELE_KIND):
    ...
    if ELE_KIND == 'INELASTIC':
        ...
        # INFO LINK: https://opensees.github.io/OpenSeesDocumentation/user/manual/material/uniaxialMaterials/HystereticSM.htmll
    if ELE_KIND == 'ELASTIC':
...
DMAX = 220        # [mm] Max. Pushover Incremental Displacement
...
xx, yy, Elastic_ST, Plastic_ST, Tangent_ST, Ductility_Rito, Over_Strength_Factor = S05.BILNEAR_CURVE(dispP, baseP, 700)
...
S04.PLOT_2D_FRAME(deformed_scale=5)  # Adjust scale factor as needed
#%%-------------------------------------------------------------
