def OPENSEEES_HYSTERETIC_FORCE_DISP_FUN(matTag, DP, FP, DN, FN,
                                            pinchX, pinchY,
    ...
    pos_disp = [0, DP[0], DP[1], DP[2]]
    pos_force = [0, FP[0], FP[1], FP[2]]
    KP = np.array([FP[0], DP[0], 
           FP[1], DP[1], 
           FP[2], DP[2]])
    
    # Negative branch points
    neg_disp = [0, DN[0], DN[1], DN[2]]
    neg_force = [0, FN[0], FN[1], FN[2]]
    ...
    ops.uniaxialMaterial('Hysteretic', matTag, *KP.flatten(), *KN.flatten(), pinchX, pinchY, damage1, damage2, beta)
