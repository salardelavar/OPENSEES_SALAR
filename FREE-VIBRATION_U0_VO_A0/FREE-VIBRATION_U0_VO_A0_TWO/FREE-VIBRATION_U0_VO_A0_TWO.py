...
SPRING_KIND = 'ELASTIC'
time, reactionE, dispE, velE, accelE, stiffnessE, periodE, E_damping_ratioE, E_periodE = FREE_VIBRATION_SDOF(IA, IU, IV, SPRING_KIND, u0, v0, a0, duration, dt)
S02.PERIOD_FUN(dispE, dt)

SPRING_KIND = 'INELASTIC'
time, reactionI, dispI, velI, accelI, stiffnessI, periodI, E_damping_ratioI, E_periodI = FREE_VIBRATION_SDOF(IA, IU, IV, SPRING_KIND, u0, v0, a0, duration, dt)
