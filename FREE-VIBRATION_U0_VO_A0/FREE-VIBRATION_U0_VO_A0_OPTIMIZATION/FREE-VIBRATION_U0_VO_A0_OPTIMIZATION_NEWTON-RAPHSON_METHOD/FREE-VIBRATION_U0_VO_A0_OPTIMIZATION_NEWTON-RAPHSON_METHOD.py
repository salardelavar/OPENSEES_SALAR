...
#%%------------------------------------------------------------------------------
# FIND BEST SPRING AREA WITH STRUCTURAL LATERAL DEMAND DISPALCEMENT:
# Define parameters
M = 50000.0       # [kg] Mass
...
FY6, DY6 = 0.2000*X, 0.41    # Near-zero stiffness
FY7, DY7 = 0.0*X, 0.52       # Zero force (failure)
    
KP = np.array([FY1, DY1, FY2, DY2, FY3, DY3, FY4, DY4, FY5, DY5, FY6, DY6, FY7, DY7])

# Compression Force-Displacement Relationship (Negative values)
FY1n, DY1n = -2.7720*X, -0.01    # First yield in compression
FY2n, DY2n = -3.1046*X, -0.02    # Peak compressive force
FY3n, DY3n = -1.6632*X, -0.04    # Post-peak softening
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "FREE-VIBRATION_U0_VO_A0_OPTIMIZATION_NEWTON-RAPHSON_METHOD.json")
#%%-------------------------------------------------------------------------------
