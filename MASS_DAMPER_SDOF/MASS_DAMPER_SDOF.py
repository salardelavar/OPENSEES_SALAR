...
u0 = 5.7     # [mm] Initial displacement applied to node 3
...
def ANALYSIS_SDOF_AMD():
    ...
    # Define materials
    ops.uniaxialMaterial('Elastic', 1, ks)       # Spring between ground and structure
    ...
    ops.integrator('DisplacementControl', 3, 1, u0)
    ops.analysis('Static')
    ops.analyze(1)
    ops.setTime(0.0)
    ops.wipeAnalysis()
