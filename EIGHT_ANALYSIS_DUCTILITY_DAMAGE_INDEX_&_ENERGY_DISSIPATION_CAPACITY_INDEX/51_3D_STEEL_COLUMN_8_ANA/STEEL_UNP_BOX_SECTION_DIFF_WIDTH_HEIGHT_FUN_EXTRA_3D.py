def STEEL_UNP_BOX_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D(secTag, STEEL_TYPE, STEEL_DENSITY, plot=True):
    """
    ...
    mat_layers = [
        ...
        (CD, PT, 0.5*CD, -0.5*PT, NFY, NFX, steelITag, 'lightgray'),                                # 03 -> PLATE
        
        (PT, ACD+PT, CD+0.5*PT, 50.0-0.5*PT, NFY, NFX, steelITag, 'lightgray'),                     # 04 -> PLATE
        (PT, ACD+PT, 0.0-0.5*PT, CD-0.5*ACD+0.5*PT, NFY, NFX, steelITag, 'lightgray'),              # 05 -> PLATE
        (CD, PT, 0.5*CD, CD+0.5*PT, NFY, NFX, steelITag, 'lightgray'),                              # 06 -> PLATE
        
        (PT, CD-ACD, CD+1.5*PT, 0.5*CD, NFY, NFX, steelITag, 'lightgray'),                          # 07 -> PLATE
        (PT, CD-ACD, 0.0-1.5*PT, 0.5*CD, NFY, NFX, steelITag, 'lightgray'),                         # 08 -> PLATE      
    ]
    ...
    if plot:
        ...
        ax.set_title(f'Steel UNP Box section with plates (Numbers shown) - Section Tag: {secTag}')
