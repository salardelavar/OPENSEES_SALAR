def STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA(secTag, STEEL_TYPE, STEEL_DENSITY, plot=True):
    ...
    steel_layers = [
        (10.0, 100.0, 5.0, 50.0, 10, 10),    # 1
        (160.0, 10.0, 90.0, 50.0, 10, 10),   # 2
        (10.0, 100.0, 175.0, 50.0, 10, 10),  # 3    
        
        (10.0, 100.0, 5.0, 150.0, 10, 10),    # 4
        (160.0, 10.0, 90.0, 150.0, 10, 10),   # 5
        (10.0, 100.0, 175.0, 150.0, 10, 10),  # 6 
        
        (6.0, 150.0, -3.0, 100.0, 10, 10),    # 7
        (6.0, 150.0, 183.0, 100.0, 10, 10),   # 8
        
        (210.0, 8.0, 90.0, -4.0, 10, 10),     # 9
        (210.0, 8.0, 90.0, 204.0, 10, 10),    # 10
    ...
    if plot:
        ...
        ax.set_title('Steel section (10 layers)')
