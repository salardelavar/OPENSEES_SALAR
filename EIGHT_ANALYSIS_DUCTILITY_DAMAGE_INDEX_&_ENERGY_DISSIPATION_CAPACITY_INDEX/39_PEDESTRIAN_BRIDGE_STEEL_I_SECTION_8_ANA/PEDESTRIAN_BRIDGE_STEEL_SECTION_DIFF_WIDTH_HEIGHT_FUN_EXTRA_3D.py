def PEDESTRIAN_BRIDGE_STEEL_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_3D(secTag, STEEL_TYPE, STEEL_DENSITY, plot=True):
    """
    ...
    steel_layers = [
        (20.0, 200.0, 10.0, 100.0, 10, 10),    # 1
        (560.0, 20.0, 300.0, 100.0, 10, 10),   # 2
        (20.0, 200.0, 590.0, 100.0, 10, 10),   # 3    
        
        (20.0, 200.0, 10.0, 3000.0, 10, 10),   # 4
        (560.0, 20.0, 300.0, 3000.0, 10, 10),  # 5
        (20.0, 200.0, 590.0, 3000.0, 10, 10),  # 6 
        
        (20.0, 2880.0, 30.0, 1550.0, 10, 10),   # 7
    ...
    if plot:
        ...
        ax.set_title('Pedestrian Bridge Steel section (7 layers)')
