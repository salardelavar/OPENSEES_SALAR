def CONCRETE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA(secTag, STEEL_TYPE, fc, Kfc,
    ...
    concrete_layers = [
        ...
        (50.0, 680.0, 75.0, 350.0),   # 2
        (50.0, 660.0, 125.0, 350.0),  # 3
        (50.0, 640.0, 175.0, 350.0),  # 4
        (50.0, 620.0, 225.0, 350.0),  # 5
        (50.0, 600.0, 275.0, 350.0),  # 6
        (50.0, 580.0, 325.0, 350.0),   # 7
        (50.0, 560.0, 375.0, 350.0),   # 8
        (50.0, 540.0, 425.0, 350.0),   # 9
        (50.0, 520.0, 475.0, 350.0),   # 10
        (50.0, 500.0, 525.0, 350.0),   # 11
        (50.0, 520.0, 575.0, 350.0),   # 12 
        (50.0, 540.0, 625.0, 350.0),   # 13
        (50.0, 560.0, 675.0, 350.0),   # 14
        (50.0, 580.0, 725.0, 350.0),   # 15
        (50.0, 620.0, 775.0, 350.0),   # 16
        (50.0, 640.0, 825.0, 350.0),   # 17
        (50.0, 660.0, 875.0, 350.0),   # 18
        (50.0, 680.0, 925.0, 350.0),   # 19
        (50.0, 700.0, 975.0, 350.0),   # 20       

    ]
    for depth, width, center_y, center_x in concrete_layers:
        x_left = center_x - width/2
        x_right = center_x + width/2
        y_bot = center_y - depth/2
        y_top = center_y + depth/2
        ops.patch('rect', coverTag, nFib, 10, x_left, y_bot, x_right, y_top)
