...
def CONCRETE_REC_SECTION_FUN(secTag, STEEL_TYPE, fc, Kfc,
    ...
    rebars = [
        (10.0,  Hsec/2 - cover, -Bsec/3),   # 1
        (10.0,  Hsec/2 - cover,  Bsec/3),   # 2
        (16.0,  Hsec/4 - cover, -Bsec/3),   # 3
        (16.0,  Hsec/4 - cover,  Bsec/3),   # 4
        (20.0,  -Hsec/6 - cover, -Bsec/3),   # 5
        (20.0,  -Hsec/6 - cover,  Bsec/3),   # 6
        (25.0, -Hsec/2 + cover, -Bsec/3),   # 7
        (25.0, -Hsec/2 + cover,  Bsec/3)    # 8
    ]
