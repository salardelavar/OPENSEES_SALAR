# DETERMINATION OF OPTIMUM STRUCTURAL INITIAL ELASTIC STIFFNESS FROM STRUCTURAL PERIOD (10 FLOORS, 4 COLUMNS) USING FINITE‑DIFFERENCE NEWTON ITERATION AND OPENSEES WITH AND WITHOUT PARALLEL COMPUTING
