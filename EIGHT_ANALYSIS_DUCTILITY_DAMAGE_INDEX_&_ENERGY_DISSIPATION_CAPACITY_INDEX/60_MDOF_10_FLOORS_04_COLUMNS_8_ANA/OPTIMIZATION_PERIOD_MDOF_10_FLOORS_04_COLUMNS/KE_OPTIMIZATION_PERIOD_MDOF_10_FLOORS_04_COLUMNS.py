...
while (RESIDUAL > TOLERANCE):
    # X -------------------    
    ANAL_TYPE = 'PERIOD'
    DATA = MDOF(X, MAT_TYPE, TOTAL_MASS, ANAL_TYPE)
    ...
    ANAL_TYPE = 'PERIOD'
    DATA = MDOF(Xmin, MAT_TYPE, TOTAL_MASS, ANAL_TYPE)
    (PERIOD_MIN, PERIOD_MAX) = DATA
    ...
    ANAL_TYPE = 'PERIOD'
    DATA = MDOF(Xmax, MAT_TYPE, TOTAL_MASS, ANAL_TYPE)
    (PERIOD_MIN, PERIOD_MAX) = DATA
    ...
    if RESIDUAL < TOLERANCE:
        print(f'\t\t Optimum X (INTIAL ELASTIC STIFFNESS):  {X:.4f}')
