...
#       DETERMINATION OF THE OPTIMUM ELASTIC STIFFNESS OF EACH COLUMN BASED ON THE STRUCTURAL PERIOD      #
#           VARATIONS THROUGH CONSTANT MASS USING FINITE-DIFFERENCE NEWTON ITERATION AND OPENSEES         #
#---------------------------------------------------------------------------------------------------------#
#           IN THIS ANALYSIS MASS IS CONSTANT BUT DEMAND VALUE (STRUCTURAL PERIOD) IS NOT CONSTANT        #
#---------------------------------------------------------------------------------------------------------#
...
# NOTICE: IN THIS ANALYSIS MASS IS CONSTANT BUT DEMAND VALUE (STRUCTURAL PERIOD) IS NOT CONSTANT
...
for II in range(0, 40):
    ...
    while (RESIDUAL > TOLERANCE):
        ...
        if RESIDUAL < TOLERANCE:
            print(f'\t\t Structural Period:                     {DEMAND:.4f}')
    ...
    STR_PERIOD_target.append(DEMAND)     
...
YDATA = STR_PERIOD_target
XLABEL = 'OPTIMUM ELASTIC COL. STIFFNESS [N/m]'
YLABEL = 'STRUCTURAL PERIOD [s]'
TITLE = f'{YLABEL} and {XLABEL} DURING 40 TIMES PERIOD ANALYSIS BY \n CHANGING THE TARGETED STRUCTURAL PERIOD: {DEMAND:.3f} [s]'
COLOR = 'purple'
