...
#      COMPREHENSIVE NONLINEAR SEISMIC ASSESSMENT OF A POST-FIRE SINGLE-DEGREE-FREEDOM WITH FOUR          #
...
def POST_FIRE_SDOF_FOUR_ELEMENTS(MAT_TYPE, TOTAL_MASS, ANAL_TYPE):
    ...
    # THERMAL EFFECTS OF STEEL MATERIAL FORCE-DISPLACEMENT   
        if II == 0:
            ...
            T = 530.0
        # FIRE EFFECTS
        kE, kFy, kFu, esu = STEEL_FIRE_PROPERTIES(T) # THERMAL EFFECTS [°C] 
...
# Save to Excel
with pd.ExcelWriter("POST_FIRE_SDOF_FOUR_ELEMENTS_8_ANA_OUTPUT.xlsx", engine='openpyxl') as writer:
