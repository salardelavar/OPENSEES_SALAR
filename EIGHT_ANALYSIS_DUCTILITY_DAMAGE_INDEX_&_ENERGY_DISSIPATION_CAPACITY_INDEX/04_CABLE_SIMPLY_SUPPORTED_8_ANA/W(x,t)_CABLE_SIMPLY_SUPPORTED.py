...
#%%----------------------------------------------------
def CABLE_ONE_ELEMENT_SIMPLY_SUPPORTED(LENGTH, AREA, MAT_TYPE, ELE_TYPE, ANAL_TYPE, TOTAL_MASS):
    # Initialize model
    ops.wipe()
    ...
    if ELE_TYPE == 'corotTruss':
        ...
        ops.element('corotTruss', 1, 1, 2, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('corotTruss', 2, 2, 3, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('corotTruss', 3, 3, 4, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('corotTruss', 4, 4, 5, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('corotTruss', 5, 5, 6, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('corotTruss', 6, 6, 7, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
    ...
    if ELE_TYPE == 'Truss': 
        ...
        ops.element('Truss', 1, 1, 2, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('Truss', 2, 2, 3, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('Truss', 3, 3, 4, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('Truss', 4, 4, 5, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('Truss', 5, 5, 6, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
        ops.element('Truss', 6, 6, 7, AREA, MAT_TAG, '-rho', ele_mass, '-doRayleigh', 1)
    ...
    if ANAL_TYPE == 'PUSHOVER': # STATIC TIME-HISTORY ANALYSIS
        ...
        DMAX = -2000.0  # [mm] Max. Vertical Displacement
...
DATA = CABLE_ONE_ELEMENT_SIMPLY_SUPPORTED(LENGTH, AREA, MAT_TYPE, ELE_TYPE, ANAL_TYPE, TOTAL_MASS)
...
# Save to Excel
with pd.ExcelWriter("W(x,t)_CABLE_SIMPLY_SUPPORTED_OUTPUT.xlsx", engine='openpyxl') as writer:
