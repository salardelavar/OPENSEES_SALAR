...
def MDOF_TWO(MAT_TYPE, TOTAL_MASS, ANAL_TYPE):
    ...
    # [kg] Mass
    MASS = [0.40 * TOTAL_MASS, # DOF 01
            0.20 * TOTAL_MASS, # DOF 02
            0.30 * TOTAL_MASS, # DOF 03
    ...
    if ANAL_TYPE == 'SEISMIC': # DYNAMIC TIME-HISTORY ANALYSIS
        ...
        SSF_X = 100.0                      # Seismic Acceleration Scale Factor in X Direction
        SSF_Y = 100.0                      # Seismic Acceleration Scale Factor in Y Direction
...
# Save to Excel
with pd.ExcelWriter("MDOF_TWO_OUTPUT.xlsx", engine='openpyxl') as writer:
