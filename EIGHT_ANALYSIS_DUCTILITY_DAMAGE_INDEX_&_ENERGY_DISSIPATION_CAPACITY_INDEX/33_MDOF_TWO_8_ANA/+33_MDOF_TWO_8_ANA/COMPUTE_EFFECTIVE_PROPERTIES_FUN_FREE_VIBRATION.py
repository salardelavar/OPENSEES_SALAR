#%% EQUIVALENT SDOF SYSTEM DERIVATION VIA DISPLACEMENT-BASED SEISMIC DESIGN PROCEDURE WITH FREE-VIBRATION ANALYSIS
...
print('Median Effective Period:                 ', np.median(EFFECTIVE_PERIOD_X))
