...
#          OF A SINGLE-DEGREE-OF-FREEDOM (SDOF) SYSTEM UTILIZING 200 GROUND MOTIONS IN OPENSEES           #
#---------------------------------------------------------------------------------------------------------#
...
for i in range(NUM_SEISMIC):
    ...
    data = SDOF(MAT_TYPE, TOTAL_MASS, ANAL_TYPE, i)
...
results_df.to_excel('SDOF_SEISMIC_EDCI_EVDR_DATA_RESULTS.xlsx', index=False)
#%%------------------------------------------------------  
XLABEL = 'Displacement'
