...
def TRUSS_ONE_ELEMENT(LENGTH, AREA, MAT_TYPE,
    ...
    if ELE_TYPE == 'corotTruss':
        ...
        ops.element('corotTruss', ele_tag, 1, 2, AREA, MAT_TAG, '-rho',AREA*DENSITY_STEEL , '-doRayleigh', 1)
    if ELE_TYPE == 'Truss': 
        ...
        ops.element('Truss', ele_tag, 1, 2, AREA, MAT_TAG, '-rho', AREA*DENSITY_STEEL , '-doRayleigh', 1)
        ele_tag += 1
    ...
    if ANAL_TYPE == 'SEISMIC': # DYNAMIC TIME-HISTORY ANALYSIS
        ...
        SSF_X = 1.10                       # Seismic Acceleration Scale Factor in X Direction
        SSF_Y = 1.10                       # Seismic Acceleration Scale Factor in Y Direction
