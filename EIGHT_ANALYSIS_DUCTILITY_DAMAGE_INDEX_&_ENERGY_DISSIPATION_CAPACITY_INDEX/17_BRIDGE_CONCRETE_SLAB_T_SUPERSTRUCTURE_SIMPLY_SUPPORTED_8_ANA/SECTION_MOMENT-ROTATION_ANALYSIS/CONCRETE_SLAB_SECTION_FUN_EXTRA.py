...
section_tag = 1
"""
def CONCRETE_SLAB_SECTION_FUN(secTag, STEEL_TYPE, fc, Kfc,
                           Bsec, Hsec, cover,
    ...
    rebars = [
        ...
        (REBAR_DIA, 0.0, -Bsec/2 + cover),           # 28
        (REBAR_DIA, 0.0,  Bsec/2 - cover),           # 29
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 1*DIST),   # 30
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 1*DIST),   # 31
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 2*DIST),   # 32
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 2*DIST),   # 33
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 3*DIST),   # 34
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 3*DIST),   # 35
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 4*DIST),   # 36
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 4*DIST),   # 37
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 5*DIST),   # 38
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 5*DIST),   # 39
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 6*DIST),   # 40
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 6*DIST),   # 41
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 7*DIST),   # 42
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 7*DIST),   # 43
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 8*DIST),   # 44
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 8*DIST),   # 45
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 9*DIST),   # 46
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 9*DIST),   # 47
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 10*DIST),   # 48
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 10*DIST),   # 49
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 11*DIST),   # 50
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 11*DIST),   # 51
        (REBAR_DIA, 0.0, -Bsec/2 + cover + 12*DIST),   # 52
        (REBAR_DIA, 0.0,  Bsec/2 - cover - 12*DIST),   # 53
        (REBAR_DIA, 0.0,  0.0),                      # 54 - x=0.0        
        
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover),           # 55
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover),           # 56
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 1*DIST),   # 57
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 1*DIST),   # 58
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 2*DIST),   # 59
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 2*DIST),   # 60
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 3*DIST),   # 61
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 3*DIST),   # 62
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 4*DIST),   # 63
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 4*DIST),   # 64
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 5*DIST),   # 65
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 5*DIST),   # 66
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 6*DIST),   # 67
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 6*DIST),   # 68
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 7*DIST),   # 69
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 7*DIST),   # 70
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 8*DIST),   # 71
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 8*DIST),   # 72
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 9*DIST),   # 73
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 9*DIST),   # 74
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 10*DIST),   # 75
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 10*DIST),   # 76
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 11*DIST),   # 77
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 11*DIST),   # 78
        (REBAR_DIA,  -Hsec/2 + cover, -Bsec/2 + cover + 12*DIST),   # 79
        (REBAR_DIA,  -Hsec/2 + cover,  Bsec/2 - cover - 12*DIST),   # 80
        (REBAR_DIA,  -Hsec/2 + cover,  0.0),                      # 81 - x=0.0
    ]
    ...
    if plot:
        ...
        ax.set_title('Slab Section with Rebars (numbers shown)')
