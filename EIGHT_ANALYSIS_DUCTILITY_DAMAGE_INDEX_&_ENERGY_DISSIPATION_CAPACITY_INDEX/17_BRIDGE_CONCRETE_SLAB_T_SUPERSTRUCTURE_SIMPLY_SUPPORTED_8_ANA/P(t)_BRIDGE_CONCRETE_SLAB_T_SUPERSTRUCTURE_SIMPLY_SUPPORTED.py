...
#       SUPPORTED SHORT SPAN BRIDGE : AN OPENSEES FRAMEWORK FOR STATIC PUSHOVER, CYCLIC DEGRADATION,      #
...
def SHORT_SPAN_T_SLAB_CONCRETE_BRIDGE(LENGTH, MAT_TYPE, ELE_TYPE, ANAL_TYPE, TOTAL_MASS):
    ...
    if ANAL_TYPE == 'PUSHOVER': # STATIC TIME-HISTORY ANALYSIS
        ...
        DMAX = -3.0    # [mm] Max. Vertical Displacement
    ...
    if ANAL_TYPE == 'CYCLIC_DISPLACEMENT': # STATIC TIME-HISTORY ANALYSIS
        IDctrlDOF = 2   # 1: Horizental Dispalcement - 2: Vertical Dispalcement
        DMAX = -1.50    # [mm] Max. Vertical Displacement
        n_points = 10000
