...
#  COMPREHENSIVE NONLINEAR SEISMIC ASSESSMENT OF STEEL A SIMPLY SUPPORTED BEAM ELEMENT : AN OPENSEES      #
...
#%%----------------------------------------------------
def BEAM_ONE_ELEMENT_SIMPLY_SUPPORTED(LENGTH, MAT_TYPE, ELE_TYPE, ANAL_TYPE, TOTAL_MASS):
    # Initialize model
    ops.wipe()
    ...
    if ANAL_TYPE == 'PUSHOVER': # STATIC TIME-HISTORY ANALYSIS
        ...
        DMAX = -150.0   # [mm] Max. Vertical Displacement
...
DATA = BEAM_ONE_ELEMENT_SIMPLY_SUPPORTED(LENGTH, MAT_TYPE, ELE_TYPE, ANAL_TYPE, TOTAL_MASS)
...
# Save to Excel
with pd.ExcelWriter("W(x,t)_BEAM_ONE_ELEMENT_OUTPUT.xlsx", engine='openpyxl') as writer:
