...
#        COMPREHENSIVE NONLINEAR SEISMIC ASSESSMENT OF CANTILEVER TRIANGLE ELEMENT : AN OPENSEES          #
...
def CANTILEVER_TRIANGLE_ELEMENT(LENGTH, HEIGHT, THICKNESS, MAT_TYPE, ANAL_TYPE, TOTAL_MASS):
    ...
    for i, j, k in ele_connect:
        if ELE_TYPE == 'tri31':
            ...
            ops.element('Tri31', ele_tag, i, j, k, THICKNESS, 'PlaneStress', MAT_TAG, 0.0, ele_massC)
        ele_tag += 1
...
THICKNESS = 100.0          # [mm] Section Width (Plane-Stress)
TOTAL_MASS = 10.0          # [kg] Total Mass of Structure
#%%----------------------------------------------------
# PERIOD ANALYSIS
...
# Save to Excel
with pd.ExcelWriter("P(t)_TRIANGLE_ELEMENT_CANTILEVER_PLANE-STRESS_OUTPUT.xlsx", engine='openpyxl') as writer:
