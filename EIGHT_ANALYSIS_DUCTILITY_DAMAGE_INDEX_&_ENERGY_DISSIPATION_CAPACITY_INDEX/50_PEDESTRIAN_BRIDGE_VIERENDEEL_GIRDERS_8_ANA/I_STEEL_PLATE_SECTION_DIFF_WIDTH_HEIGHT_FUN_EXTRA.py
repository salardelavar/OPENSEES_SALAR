def I_STEEL_PLATE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA(secTag, STEEL_TYPE, STEEL_DENSITY, plot=True):
    """
    ...
    steel_layers = [
        (20.0, 220.0, 10.0, 110.0, 10, 10),   # 1
        (220.0, 20.0, 130.0, 110.0, 10, 10),  # 2
        (20.0, 220.0, 230.0, 110.0, 10, 10),  # 3    
    ...
    if plot:
        ...
        ax.set_title('Steel section (3 layers)')
