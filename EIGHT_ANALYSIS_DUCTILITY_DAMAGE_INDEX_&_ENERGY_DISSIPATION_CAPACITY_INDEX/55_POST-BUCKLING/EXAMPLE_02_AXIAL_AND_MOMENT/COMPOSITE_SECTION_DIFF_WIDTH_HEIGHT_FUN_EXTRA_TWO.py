def COMPOSITE_SECTION_DIFF_WIDTH_HEIGHT_FUN_EXTRA_TWO(secTag, STEEL_TYPE, fc, Kfc, CONCRETE_DENSITY, plot=True):
    """
    ...
    mat_layers = [
        ...
        # STEEL SECTION
        (10.0, 150.0, 0.5*CD-0.25*CD, 0.5*CW, NFY, NFX, steelITag, 'lime'),                # 54 -> CROSSED SECTION
        (240.0, 10.0, 0.5*CD, 0.5*CW, NFY, NFX, steelITag, 'lime'),                        # 55 -> CROSSED SECTION
        (10.0, 150.0, 0.5*CD+0.25*CD, 0.5*CW, NFY, NFX, steelITag, 'lime'),                # 56 -> CROSSED SECTION   
