def COMPOSITE_REC_CROSS_SHAPED_STEEL_SECTION_FUN_EXTRA(secTag, HSec, BSec, cover,
    ...
    coreTag, coverTag, steelTag, steelITag = secTag + 1000, secTag + 2000, secTag + 3000, secTag + 4000
    ...
    rebars = [
        ...
        (REBAR,  0.0, -BSec/2 + cover),               # 5
        (REBAR,  0.0, +BSec/2 - cover),               # 6
        
        (REBAR,  HSec/2 - cover, 0.0),                # 7
        (REBAR,  -HSec/2 + cover, 0.0),               # 8
    ]
