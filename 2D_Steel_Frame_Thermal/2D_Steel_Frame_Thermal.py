...
Thermal = 865.0           # Temperature (°C)
distributed_load = -0.35  # [kN/mm] Distributed load
...
def R_RECTANGULAR_CONCRETE_SECTION(secTag):
...
#Depth = R_RECTANGULAR_CONCRETE_SECTION(secTag)
#--------------------------------------------------------------------
