...
def BEAM_ONE_ELEMENT(LENGTH, MAT_TYPE, ELE_TYPE, ANAL_TYPE, TOTAL_MASS):
    ...
    SEC_TAG = 1
    #Depth, Ele_Mass = S08.DOUBLE_I_SECTION_FIBER(secTag, matTag, PLOT=True, DENSITY=DENSITY_STEEL)
    Depth, Ele_Mass = S08.DOUBLE_I_SECTION_QUAD(SEC_TAG, MAT_TAG, PLOT=True, DENSITY=DENSITY_STEEL)
    #%% CREATE ELEMENTS
    ele_tag = 1
    transfTag = 1
...
plt.title('Behavior of column - Stress-strain of Top and Bottom Fibers Curve')
plt.grid(True)
plt.legend()
plt.show()
