...
source READ_AND_FIND_MAX_ABS_FUN.tcl

set tStart [clock clicks -milliseconds]
set NUM_INCREMENT 20000; #Number of Analysis Increment 
...
set B 300; #Width of Column Section
set Ela 23500;# Modulus of Elasticity of Section
set Le 3000;# Length of Column
set Dpr 0.02;#Damping ratio
set RZD [randUniform 9.9 18.1];# Column Rebar Size Diameter

# write each random rebar diameter in each iterations
write_variable_to_file DATA/NON_DYN_CONFINED/RD_$i.txt "$i" $RZD
...
set PERIOD [expr  2*3.1415*sqrt($MASS/$Ke)];# Sitffness of Structure
...
set fc 		-25;		# CONCRETE Compressive Strength, ksi   (+Tension, -Compression)
...
set eps2U	-0.012;			# strain at ultimate stress
...
set Cy 0.02;		# STEEL yield strain
