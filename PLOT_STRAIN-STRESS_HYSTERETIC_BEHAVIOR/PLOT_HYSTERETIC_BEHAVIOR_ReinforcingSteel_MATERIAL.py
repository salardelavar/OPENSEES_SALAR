...
# Definition of Steel04 material
ops.uniaxialMaterial('ReinforcingSteel', matTag, fy, fu, Es, Esh, esh, esu)
"""
...
"""
# INFO LINK: https://openseespydoc.readthedocs.io/en/latest/src/ReinforcingSteel.html
# MORE INFO: https://opensees.berkeley.edu/wiki/index.php/Reinforcing_Steel_Material
#%% ------------------------------------------------------------
...
plt.title('Hysteresis Loop - (ReinforcingSteel) Steel Material')
plt.grid(True)
plt.tight_layout()
plt.show()
