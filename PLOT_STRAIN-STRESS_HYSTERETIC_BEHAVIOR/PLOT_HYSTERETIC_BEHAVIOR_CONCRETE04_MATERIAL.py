...
ops.uniaxialMaterial('Concrete04', coreTag, fc1C, eps1C, eps2C, EcC,ftC, Ets, beta) # build core concrete (confined)
ops.uniaxialMaterial('Concrete02', coverTag, fc1U, eps1U, eps2U, EcU,ftU, Ets, beta) # build cover concrete (unconfined)
