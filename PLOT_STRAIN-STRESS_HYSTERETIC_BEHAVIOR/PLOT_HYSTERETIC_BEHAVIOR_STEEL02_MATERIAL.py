...
# Definition of Steel02 material
ops.uniaxialMaterial('Steel02', matTag, fy, Es, b, R0, cR1, cR2, a1, a2, a3, a4)
# INFO LINK: https://openseespydoc.readthedocs.io/en/latest/src/steel02.html
# MORE INFO: https://opensees.berkeley.edu/wiki/index.php?title=OpenSees_uniaxialMaterial_Arguments_--_Steel02
#%% ------------------------------------------------------------
...
plt.title('Hysteresis Loop - Steel02 Steel Material')
plt.grid(True)
plt.tight_layout()
plt.show()
