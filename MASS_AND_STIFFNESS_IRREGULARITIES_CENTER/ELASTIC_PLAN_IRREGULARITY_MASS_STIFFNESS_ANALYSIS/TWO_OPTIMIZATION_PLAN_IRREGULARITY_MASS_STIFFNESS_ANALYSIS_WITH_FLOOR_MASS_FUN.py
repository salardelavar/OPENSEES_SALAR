...
def PLAN_IRREGULARITY_MASS_STIFFNESS_ANALYSIS_WITH_FLOOR_MASS_FUN(Tx, Ty, storey_height=3000.0):
    ...
    columns = np.array([
        [   0,    0, 500, 500, 25000, 800],   # C1  corner
        [6000,    0, 500, 500, 25000, 1000],  # C2
        [12000,   0, 500, 500, 25000, 1100],  # C3
        [12000,4000, 500, 500, 25000, 900],   # C4
        [12000,8000, 500, 500, 25000, 145],   # C5
        [6000, 8000, 500, 500, 25000, 920],   # C6
        [   0, 8000, 500, 500, 25000, 850],   # C7
        [   0, 4000, 500, 500, 25000, 800],   # C8
        [3000, 2000, 350, 350, 30000,1100],   # C9  interior heavier + stiffer
        [9000, 2000, 350, 350, 30000,1200],   # C10
        [3000, 6000, 350, 350, 30000,1800],   # C11
        [9000, 6000, 350, 350, 30000,1200],   # C12
    ])
...
Y = 1000          # Intial Guess - Wall Thickness in along Y
