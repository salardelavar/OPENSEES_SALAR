...
def PLAN_IRREGULARITY_MASS_STIFFNESS_ANALYSIS_WITH_FLOOR_MASS_FUN(Tx, Ty, storey_height=3000.0):
    ...
    L = storey_height                    # [mm] Column/wall Height 
    ...
    columns = np.array([
        [   0,    0, 500, 500, Ec, 8000],   # C1  corner
        [6000,    0, 500, 500, Ec, 10000],  # C2
        [12000,   0, 500, 500, Ec, 11000],  # C3
        [12000,4000, 500, 500, Ec, 9000],   # C4
        [12000,8000, 500, 500, Ec, 1450],   # C5
        [6000, 8000, 500, 500, Ec, 9200],   # C6
        [   0, 8000, 500, 500, Ec, 8500],   # C7
        [   0, 4000, 500, 500, Ec, 8000],   # C8
        [3000, 2000, 350, 350, Ec, 11000],   # C9  interior heavier + stiffer
        [9000, 2000, 350, 350, Ec, 12000],   # C10
        [3000, 6000, 350, 350, Ec, 18000],   # C11
        [9000, 6000, 350, 350, Ec, 12000],   # C12
    ])
...
X = 100.0         # Intial Guess - Wall Thickness in along X
Y = 1000.0        # Intial Guess - Wall Thickness in along Y
...
DEMANDx = 0.0     # In along X - Target Value is Difference between Center of Stiffness and Center of Mass
DEMANDy = 0.0     # In along Y - Target Value is Difference between Center of Stiffness and Center of Mass
