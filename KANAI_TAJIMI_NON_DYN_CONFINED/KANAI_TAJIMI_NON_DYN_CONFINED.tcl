...
set NUM_INCREMENT 5000; #Number of Analysis Increment 
...
set GMfile "ground_acceleration.txt" ;			# ground-motion filenames
set GMfact 1;				# ground-motion scaling factor

# set up ground-motion-analysis parameters
set DtAnalysis	0.01;	# time-step Dt for lateral analysis
set TmaxAnalysis	[expr 10.];	# maximum duration of ground-motion analysis -- should be 10*$sec
