...
#                EXPLOSION IMPACT LOADING ANALYSIS OF CONCRETE FRAME                 # 
...
"""
--------------------------------------------------------
 Analysis of Explosion Impact Loading on Concrete Frame
--------------------------------------------------------

This program performs a nonlinear dynamic analysis of a concrete frame subjected to explosion impact loading using OpenSees.
...
The analysis provides valuable insights into how strain hardening and ultimate strain criteria affect
 the frame's response to blast loading, which is crucial for blast-resistant design.
...
results_df.to_excel('CONCRETE_FRAME_IMPACT_LOAD_EXPLOSION_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
