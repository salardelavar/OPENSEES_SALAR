...
#--------------------------------------------------------------------------------------------------------------------#
#                                        FREE-VIBRATION ANALYSIS WITH INITIAL DISPLACEMENT                           #
#--------------------------------------------------------------------------------------------------------------------#
...
def FV_ANALYSIS(LENGTH_COL, LENGTH_BM, u0, STEEL_KIND):
    ...
    if FV == 'Y':
        ops.integrator('DisplacementControl', 3, 2, u0) # Initial displacement applied to the node 3
    ops.analysis('Static')
    ops.analyze(1)
...
DATA = FV_ANALYSIS(LENGTH_COL, LENGTH_BM, u0, STEEL_KIND=1)
...
DATA02 = FV_ANALYSIS(LENGTH_COL, LENGTH_BM, u0, STEEL_KIND=2)
...
results_df.to_excel('CONCRETE_FRAME_FREE-VIBRATION_U0_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "CONCRETE_FRAME_FREE-VIBRATION_U0.json")
#%%-------------------------------------------------------------------------------
