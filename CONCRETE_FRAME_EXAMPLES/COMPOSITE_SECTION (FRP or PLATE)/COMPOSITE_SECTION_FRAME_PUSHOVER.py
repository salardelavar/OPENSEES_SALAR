...
#            PUSHOVER ANALYSIS OF COMPOSITE SECTION FRAME AND CALCULATE STRUCTURAL BEHAVIOR COEFFICIENT        #               
#--------------------------------------------------------------------------------------------------------------#
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "COMPOSITE_SECTION_FRAME_PUSHOVER.json")
#%%-------------------------------------------------------------------------------
