...
#                    CONFINEMENT ENHANCEMENT RATIO OF CONCRETE FRAME WITH RIGID ROOF USING OPENSEES                  #
#--------------------------------------------------------------------------------------------------------------------#
...
results_df.to_excel('CONCRETE_FRAME_DUCTILITY_DAMAGE_INDEX_CONFINEMENT_ENHANCEMENT_RATIO_RIGID_ROOF_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "CONCRETE_FRAME_DUCTILITY_DAMAGE_INDEX_CONFINEMENT_ENHANCEMENT_RATIO_RIGID_ROOF.json")
#%%-------------------------------------------------------------------------------
