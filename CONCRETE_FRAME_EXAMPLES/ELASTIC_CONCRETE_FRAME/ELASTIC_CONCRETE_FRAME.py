...
Ec = 4700*np.sqrt(np.abs(fcU)) # [N/mm^1] Concrte Young's Modulus
...
ops.element('elasticBeamColumn', 1, 1, 3, AREAc, Ec, IZc, 1) # COLUMN 01
ops.element('elasticBeamColumn', 2, 2, 4, AREAc, Ec, IZc, 1) # COLUMN 02 
ops.element('elasticBeamColumn', 3, 3, 4, AREAb, Ec, IZb, 1) # BEAM 01
