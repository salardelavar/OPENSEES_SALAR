...
# PUSHOVER ANALYSIS OF CONCRETE FRAME. EVALUATING STRAIN HARDENING AND ULTIMATE STRAIN CRITERIA USING OPENSEES #
...
#%% DEFINE PARAMETٍERS FOR NONLINEAR STATIC ANALYSIS 
DMAX = 450              # [mm] Maximum Displacement
...
results_df.to_excel('CONCRETE_FRAME_PUSHOVER_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
