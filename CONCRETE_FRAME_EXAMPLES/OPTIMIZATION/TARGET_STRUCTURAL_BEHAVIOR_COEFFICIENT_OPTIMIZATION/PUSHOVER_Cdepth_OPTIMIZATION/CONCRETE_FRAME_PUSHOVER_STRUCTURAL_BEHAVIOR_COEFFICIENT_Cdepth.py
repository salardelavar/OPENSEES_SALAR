...
# DEPTH FOR A TARGET STRUCTURAL BEHAVIOR COEFFICIENT VIA THE NEWTON-RAPHSON METHOD.                       #
#---------------------------------------------------------------------------------------------------------#
...
#%%------------------------------------------------------------------------------
# FIND BEST COLUMN CONCRETE SECTION DEPTH WITH STRUCTURAL BEHAVIOR COEFFICIENT OPTIMIZATION:
...
TARGET_R = 7.5     # Target Structural Behavior Coefficient
...
results_df.to_excel('CONCRETE_FRAME_PUSHOVER_STRUCTURAL_BEHAVIOR_COEFFICIENT_Cdepth_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
