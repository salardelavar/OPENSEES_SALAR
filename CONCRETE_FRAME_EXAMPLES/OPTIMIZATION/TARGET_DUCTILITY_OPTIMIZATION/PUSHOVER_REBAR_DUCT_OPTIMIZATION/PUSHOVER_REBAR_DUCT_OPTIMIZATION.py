...
#---------------------------------------------------------------------------------------------------------#
#               FIND BEST COLUMN REBAR DIAMETER WITH DEFINED STRUCTURAL DUCTILITY RATIO                   #
...
#%%------------------------------------------------------------------------------
# FIND BEST COLUMN REBAR DIAMETER WITH STRUCTURAL DUCTILITY RATIO:
...
TARGET_DUCT = 3.5  # [mm/mm] Target Structural Ductility Ratio
...
results_df.to_excel('PUSHOVER_REBAR_DUCT_OPTIMIZATION_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
