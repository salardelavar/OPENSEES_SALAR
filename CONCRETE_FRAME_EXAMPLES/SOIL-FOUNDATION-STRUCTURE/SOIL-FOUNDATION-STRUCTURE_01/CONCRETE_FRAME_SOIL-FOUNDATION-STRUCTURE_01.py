...
#%%------------------------------------------------------------------------------
def PD_ANALYSIS(STEEL_KIND, ANA_KIND, SPRING_KIND):
    # Reset model
    ops.wipe()
    ...
    ops.node(1000, 0.0, 0.0)
    ops.node(2000, LENGTH_BM, 0.0)
    ...
    if SPRING_KIND == 'INELASTIC': 
        ...
        kh = np.array([[0.05, 2200.0], [0.15, 2700.0], [0.25, 2700.0], [0.3, 2500.5], [0.5, 2100.5]])                   # k horizontal
...
DATA = PD_ANALYSIS(STEEL_KIND=2, ANA_KIND='PUSHOVER', SPRING_KIND = 'NO-TENSION')
...
DATA = PD_ANALYSIS(STEEL_KIND=2, ANA_KIND='DYNAMIC', SPRING_KIND = 'NO-TENSION')
