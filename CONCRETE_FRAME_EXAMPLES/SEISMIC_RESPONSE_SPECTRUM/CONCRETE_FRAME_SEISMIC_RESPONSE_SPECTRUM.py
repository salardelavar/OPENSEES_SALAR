...
dt = 0.01        # [s] Time step
MASS = 12000     # [kg] Mass of the ech Column
#%%------------------------------------------------------------------------------
J_MAX = 200      # Dynamic Analysis steps for the simulation
#%%------------------------------------------------------------------------------
...
def SEISMIC_ANALYSIS_RS(j, J_MAX, LENGTH_COL, LENGTH_BM, STEEL_KIND):
...
for j in range(J_MAX):
    DATA = SEISMIC_ANALYSIS_RS(j, J_MAX, LENGTH_COL, LENGTH_BM, STEEL_KIND=2)
...
plt.plot(max_PERIOD_02, max_displacement, color='brown', linewidth=5)
#plt.scatter(max_PERIOD_02, max_displacement, color='brown', linewidth=5)
plt.title('Displacement Response Spectrum')
plt.ylabel('Displacement [mm]')
plt.xlabel('Structure Period [s]')
plt.grid()
plt.show()

plt.figure(14, figsize=(12, 8))
plt.plot(max_PERIOD_02, max_velocity, color='purple', linewidth=5)
#plt.scatter(max_PERIOD_02, max_velocity, color='purple', linewidth=5)
...
plt.figure(14, figsize=(12, 8))
plt.plot(max_PERIOD_02, max_acceleration, color='green', linewidth=5)
#plt.scatter(max_PERIOD_02, max_acceleration, color='green', linewidth=5)
...
plt.plot(max_PERIOD_02, max_base_reaction, color='lime', linewidth=5)
#plt.scatter(max_PERIOD_02, max_base_reaction, color='lime', linewidth=5)
plt.title('Base-reaction Response Spectrum')
...
plt.plot(max_PERIOD_02, max_damping, color='black', linewidth=5)
#plt.scatter(max_PERIOD_02, max_damping, color='black', linewidth=5)
plt.title('Structure Damping Ratio Response Spectrum')
...
results_df.to_excel('CONCRETE_FRAME_SEISMIC_RESPONSE_SPECTRUM_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
