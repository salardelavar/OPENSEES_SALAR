...
#          SENSITIVITY ANALYSIS OF CONCRETE FRAME BEHAVIOR: INVESTIGATING THE IMPACT OF COLUMN HEIGHT AND      #
...
results_df.to_excel('CONCRETE_FRAME_SENSITIVITY_COLUMN_HEIGHT_&_BEAM_LENGTH_&_MASS_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
def PLOT_HEATMAP(df):
    import matplotlib.pyplot as plt
    import numpy as np
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "CONCRETE_FRAME_SENSITIVITY_COLUMN_HEIGHT_&_BEAM_LENGTH_&_MASS.json")
#%%------------------------------------------------------------------------------  