...
def SEISMIC_ANALYSIS(LENGTH_COL, LENGTH_BM, STEEL_KIND):
...
DATA = SEISMIC_ANALYSIS(LENGTH_COL, LENGTH_BM, STEEL_KIND=1)
...
results_df.to_excel('CONCRETE_FRAME_SEISMIC_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "CONCRETE_FRAME_SEISMIC.json")
#%%-------------------------------------------------------------------------------
