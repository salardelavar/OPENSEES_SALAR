...
The script demonstrates professional-grade analysis combining FEMA-356 pushover methods with ASCE 7-style dynamic performance evaluation.
"""
...
import STRESS_STRAIN_FUN as S08
...
SSF_X = 10.00    # Seismic Acceleration Scale Factor in X Direction
...
#%%------------------------------------------------------------------------------
def PD_ANALYSIS(STEEL_KIND, ANA_KIND, ELE_KIND):
    # Reset model
    ops.wipe()
    ...
    if ELE_KIND == 'INELASTIC':
        ...
        ELE_TAG = 1 
        SECTION_NUM = 1
        S08.STRESS_STRAIN_CONCRETE('01_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hc*0.5, 0)                    # CONCRETE BOTTOM FIBER
        S08.STRESS_STRAIN_CONCRETE('01_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hc*0.5, 0)                    # CONCRETE TOP FIBER
        S08.STRESS_STRAIN_REBAR('01_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hc*0.5+coverC, -0.5*Bc+coverC)   # REBAR BOTTOM FIBER
        S08.STRESS_STRAIN_REBAR('01_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hc*0.5-coverC, -0.5*Bc+coverC)   # REBAR TOP FIBER
        
        # ELEMENT 02
        ELE_TAG = 2 
        SECTION_NUM = 1
        S08.STRESS_STRAIN_CONCRETE('02_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hc*0.5, 0)                    # CONCRETE BOTTOM FIBER
        S08.STRESS_STRAIN_CONCRETE('02_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hc*0.5, 0)                    # CONCRETE TOP FIBER
        S08.STRESS_STRAIN_REBAR('02_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hc*0.5+coverC, -0.5*Bc+coverC)   # REBAR BOTTOM FIBER
        S08.STRESS_STRAIN_REBAR('02_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hc*0.5-coverC, -0.5*Bc+coverC)   # REBAR TOP FIBER
        
        # ELEMENT 03
        ELE_TAG = 3 
        SECTION_NUM = 1
        S08.STRESS_STRAIN_CONCRETE('03_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hc*0.5, 0)                    # CONCRETE BOTTOM FIBER
        S08.STRESS_STRAIN_CONCRETE('03_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hc*0.5, 0)                    # CONCRETE TOP FIBER
        S08.STRESS_STRAIN_REBAR('03_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hc*0.5+coverC, -0.5*Bc+coverC)   # REBAR BOTTOM FIBER
        S08.STRESS_STRAIN_REBAR('03_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hc*0.5-coverC, -0.5*Bc+coverC)   # REBAR TOP FIBER
        
        # ELEMENT 07
        ELE_TAG = 7
        SECTION_NUM = 1
        S08.STRESS_STRAIN_CONCRETE('07_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hb*0.5, 0)                    # CONCRETE BOTTOM FIBER
        S08.STRESS_STRAIN_CONCRETE('07_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hb*0.5, 0)                    # CONCRETE TOP FIBER
        S08.STRESS_STRAIN_REBAR('07_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hb*0.5+coverB, -0.5*Bb+coverB)   # REBAR BOTTOM FIBER
        S08.STRESS_STRAIN_REBAR('07_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hb*0.5-coverB, -0.5*Bb+coverB)   # REBAR TOP FIBER
        
        # ELEMENT 08
        ELE_TAG = 8
        SECTION_NUM = 1
        S08.STRESS_STRAIN_CONCRETE('08_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hb*0.5, 0)                    # CONCRETE BOTTOM FIBER
        S08.STRESS_STRAIN_CONCRETE('08_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hb*0.5, 0)                    # CONCRETE TOP FIBER
        S08.STRESS_STRAIN_REBAR('08_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hb*0.5+coverB, -0.5*Bb+coverB)   # REBAR BOTTOM FIBER
        S08.STRESS_STRAIN_REBAR('08_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hb*0.5-coverB, -0.5*Bb+coverB)   # REBAR TOP FIBER

        # ELEMENT 09
        ELE_TAG = 9 
        SECTION_NUM = 1
        S08.STRESS_STRAIN_CONCRETE('09_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hb*0.5, 0)                    # CONCRETE BOTTOM FIBER
        S08.STRESS_STRAIN_CONCRETE('09_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hb*0.5, 0)                    # CONCRETE TOP FIBER
        S08.STRESS_STRAIN_REBAR('09_STRESS_STRAIN_BOT', ELE_TAG, SECTION_NUM, -Hb*0.5+coverB, -0.5*Bb+coverB)   # REBAR BOTTOM FIBER
        S08.STRESS_STRAIN_REBAR('09_STRESS_STRAIN_TOP', ELE_TAG, SECTION_NUM, +Hb*0.5-coverB, -0.5*Bb+coverB)   # REBAR TOP FIBER
...
DATA = PD_ANALYSIS(STEEL_KIND, ANA_KIND, ELE_KIND)
...
S04.PLOT_2D_FRAME(deformed_scale=1)  # Adjust scale factor as needed
#%%-----------------------------------------------------------------------------
# PLOT STRESS-STRAIN FROM DEFINED SECTION
S08.STRESS_STRAIN_PLOT(1)
S08.STRESS_STRAIN_PLOT(2)
S08.STRESS_STRAIN_PLOT(3)
S08.STRESS_STRAIN_PLOT(7)
S08.STRESS_STRAIN_PLOT(8)
S08.STRESS_STRAIN_PLOT(9)
#%%-----------------------------------------------------------------------------
...
plt.xlabel('Time [s]')
plt.ylabel('Shear Base-reaction [N] from Elastic Dynamic Analysis')
plt.title(f'Time vs Base-reaction - MAX. ABS: {BASE_Ze[-1]}')
plt.grid()
plt.show()
...
plt.xlabel('Time [s]')
plt.ylabel('Shear Base-reaction [N] from Inelastic Dynamic Analysis')
plt.title(f'Time vs Base-reaction - MAX. ABS: {BASE_Zp[-1]}')
plt.grid()
plt.show()
...
plt.xlabel('Time [s]')
plt.ylabel('Axial Base-reaction [N] from Elastic Dynamic Analysis')
...
plt.xlabel('Time [s]')
plt.ylabel('Axial Base-reaction [N] from Inelastic Dynamic Analysis')
...
results_df.to_excel('CONFINEMENT_NONCONSTANT_ELASTIC_OR_INELASTIC_FRAME_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "CONFINEMENT_NONCONSTANT_ELASTIC_OR_INELASTIC_FRAME.json")
#%%-------------------------------------------------------------------------------
