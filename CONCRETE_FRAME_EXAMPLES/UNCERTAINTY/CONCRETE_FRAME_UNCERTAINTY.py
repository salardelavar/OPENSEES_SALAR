...
mean_capacity = np.mean(0.5*FORCE_Sd_MAX)    # Mean Element Ultimate Capacity
std_dev_capacity = np.std(0.5*FORCE_Sd_MAX)  # Std Element Ultimate Capacity
num_sim = num_samples
...
S01.NEURAL_NETWORK_FAILURE_PROBABILIYY_ESTIMATION(max_base_reaction, X2, num_samples)
#%%------------------------------------------------------------------------------------------------
