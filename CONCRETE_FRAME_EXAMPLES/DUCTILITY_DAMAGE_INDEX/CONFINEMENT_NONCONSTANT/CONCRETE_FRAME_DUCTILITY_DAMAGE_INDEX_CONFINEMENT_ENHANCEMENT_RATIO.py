...
FORCE_Sd, FORCE_Ad, MOMENTd, DISP_Xd, DISP_Yd, ROTd, KAd, KSd, KId, timed, velocity_Xd, velocity_Yd, acceleration_Xd, acceleration_Yd, PERIOD_01d, PERIOD_02d, damping_ratio = DATA
...
plt.title(f'Rotation vs Moment Base-reaction')
plt.grid()
plt.show()
