...
def THERMAL_ANALYSIS():
    ...
    ops.eleLoad('-ele', 1, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 2, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 3, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 4, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 5, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 6, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 7, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 8, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 9, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 10, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 11, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ops.eleLoad('-ele', 12, '-type', '-beamThermal', Max_Thermal, -DD, Max_Thermal, DD)  
    ...
    #ops.recorder('Element', '-file', 'STRESS_STRAIN_BOT_CONCRETE.txt', '-time', '-ele', 9, 'section', secTagB, 'fiber', -DD, 0, 'stressStrain')
    #ops.recorder('Element', '-file', 'STRESS_STRAIN_TOP_CONCRETE.txt', '-time', '-ele', 9, 'section', secTagB, 'fiber', +DD, 0, 'stressStrain')
    #ops.recorder('Element', '-file', 'STRESS_STRAIN_BOT_REBAR.txt', '-time', '-ele', 9, 'section', secTagB, 'fiber', -DD+coverB, -0.5*Bb+coverB, 'stressStrain')
    #ops.recorder('Element', '-file', 'STRESS_STRAIN_TOP_REBAR.txt', '-time', '-ele', 9, 'section', secTagB, 'fiber', +DD-coverB, -0.5*Bb+coverB, 'stressStrain')
    ...
    return FORCE_S, FORCE_A, MOMENT, DISP_X, DISP_Y, ROT, KA, KS, KI, THERMAL_STEP
...
# WITHOUT HARDENING AND ULTIMATE STRAIN
FORCE_S, FORCE_A, MOMENT, DISP_X, DISP_Y, ROT, KA, KS, KI, THERMAL_STEP = THERMAL_ANALYSIS()
