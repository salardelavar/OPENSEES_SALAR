...
#                         HARMONIC IMPACT LOADING ANALYSIS OF CONCRETE FRAME WITH VISCOUS DAMPER.                    # 
#--------------------------------------------------------------------------------------------------------------------#
...
load_time, harmonic_load = S09.HARMONIC_IMPACT_LOAD(force_amplitude, impact_time, DT, omega_n, PLOT=True) 
#%%------------------------------------------------------------------------------
...
results_df.to_excel('CONFINEMENT_NONCONSTANT_ELASTIC_OR_INELASTIC_FRAME_IMPACT_LOAD_VISCOUS_DAMPER_RESULTS.xlsx', index=False) 
#%%------------------------------------------------------------------------------
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "CONFINEMENT_NONCONSTANT_ELASTIC_OR_INELASTIC_FRAME_IMPACT_LOAD_VISCOUS_DAMPER.json")
#%%-------------------------------------------------------------------------------
