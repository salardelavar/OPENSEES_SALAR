...
# COMPARATIVE ANALYSIS OF AXIAL FORCE–MOMENT (P–M) INTERACTION IN CONFINED REINFORCED CONCRETE WITH PLATE #
...
results_df.to_excel('P-M_INTERACTION_COMPSITE_CONCRETE_RESULTS.xlsx', index=False) 