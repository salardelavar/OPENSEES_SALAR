...
#  I AND DOUBLE I SECTIONS WITH PLATE: EVALUATING STRAIN HARDENING EFFECTS AND ULTIMATE STRAIN CRITERIA   #
#---------------------------------------------------------------------------------------------------------#
#                          THIS PROGRAM WRITTEN BY SALAR DELAVAR GHASHGHAEI (QASHQAI)                     #
#                                   EMAIL: salar.d.ghashghaei@gmail.com                                   #
###########################################################################################################
"""
Performs a comparative analysis of Double I Section columns' axial force-moment (P-M)
...
3. Section Modeling: Creates a Double I Steel Section with fiber discretization.
