...
# COMPREHENSIVE NONLINEAR SEISMIC ASSESSMENT OF A SINGLE-DEGREE-FREEDOM WITH FOUR ELEMENTS STRUCTURE :    #
...
# Save to Excel
with pd.ExcelWriter("SDOF_FOUR_ELEMENTS_8_ANA_OUTPUT.xlsx", engine='openpyxl') as writer:
