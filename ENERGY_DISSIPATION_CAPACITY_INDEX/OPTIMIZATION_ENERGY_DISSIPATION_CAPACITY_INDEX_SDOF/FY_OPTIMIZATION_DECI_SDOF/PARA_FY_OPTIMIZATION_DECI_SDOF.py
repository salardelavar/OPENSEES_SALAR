...
#     DETERMINATION OF OPTIMUM STRUCTURAL YIELD STRENGTH FROM ENERGY DISSIPATION CAPACITY INDEX USING     #
...
#%%----------------------------------------------------
def SDOF(FY, MAT_TYPE, TOTAL_MASS, ANAL_TYPE):
    # Initialize model
    ops.wipe()
...
#%%----------------------------------------------------
# ----------------------------------------------------------------------------------------------------
# FIND THE OPTIMUM VALUE (NEWTON-RAPHSON SOLVER FOR OPTIMAL YIELD STRENGTH) WITH PARALLEL COMPUTING
# ----------------------------------------------------------------------------------------------------
import time as TI
...
def OPTIMIZE_FY():
    X = 100000        # Intial Guess for X -> Yield Strength Force of Structure
