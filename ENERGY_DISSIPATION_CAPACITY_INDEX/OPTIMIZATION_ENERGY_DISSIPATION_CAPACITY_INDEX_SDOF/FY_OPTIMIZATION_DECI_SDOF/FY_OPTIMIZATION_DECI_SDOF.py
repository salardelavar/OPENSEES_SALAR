...
# ---------------------------------------------------------------------------
# FIND THE OPTIMUM VALUE (NEWTON-RAPHSON SOLVER FOR OPTIMAL YIELD STRENGTH)
# ---------------------------------------------------------------------------
import time as TI
import numpy as np
...
while (RESIDUAL > TOLERANCE):
    ...
    if RESIDUAL < TOLERANCE:
        print(f'\t\t Optimum X (YIELD STRENGTH):         {X:.4f}')
...
DATA = SDOF(FY, MAT_TYPE, TOTAL_MASS, ANAL_TYPE)
