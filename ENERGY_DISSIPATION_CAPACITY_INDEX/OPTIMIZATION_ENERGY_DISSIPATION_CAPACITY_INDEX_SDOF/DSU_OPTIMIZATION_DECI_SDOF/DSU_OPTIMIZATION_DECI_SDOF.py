...
# DETERMINATION OF OPTIMUM STRUCTURAL ULTIMATE DISPALCEMENT FROM ENERGY DISSIPATION CAPACITY INDEX USING  #
...
#%%----------------------------------------------------
def SDOF(DSU, MAT_TYPE, TOTAL_MASS):
    # Initialize model
    ops.wipe()
...
while (RESIDUAL > TOLERANCE):
    ...
    DATA = SDOF(X, MAT_TYPE, TOTAL_MASS)
    ...
    Xmin = X - ESP
    ANAL_TYPE = 'CYCLIC_DISPLACEMENT'
    DATA = SDOF(Xmin, MAT_TYPE, TOTAL_MASS)
    (reaction_CP, disp_CP, DI_CP,
     PERIOD_MIN_CP, PERIOD_MAX_CP) = DATA
    ...
    Xmax = X + ESP
    ANAL_TYPE = 'CYCLIC_DISPLACEMENT'
    DATA = SDOF(Xmax, MAT_TYPE, TOTAL_MASS)
    (reaction_CP, disp_CP, DI_CP,
     PERIOD_MIN_CP, PERIOD_MAX_CP) = DATA
...
DATA = SDOF(DSU, MAT_TYPE, TOTAL_MASS)
