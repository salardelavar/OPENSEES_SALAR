...
#%%----------------------------------------------------
def SDOF(DUCT, MAT_TYPE, TOTAL_MASS, ANAL_TYPE):
    # Initialize model
    ops.wipe()
...
#%%----------------------------------------------------
# ----------------------------------------------------------------------------------------------------
# FIND THE OPTIMUM VALUE (NEWTON-RAPHSON SOLVER FOR OPTIMAL DUCTILITY RATIO) WITH PARALLEL COMPUTING
# ----------------------------------------------------------------------------------------------------
import time as TI
...
def OPTIMIZE_DUCT():
    X = 4.0           # Intial Guess for X -> Structural Ductility Ratio
    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        while RESIDUAL > TOLERANCE and IT < ITMAX:
            ...
            if RESIDUAL < TOLERANCE:
                print(f'\t\t Optimum Ductility Ratio:          {X:.4f}')
