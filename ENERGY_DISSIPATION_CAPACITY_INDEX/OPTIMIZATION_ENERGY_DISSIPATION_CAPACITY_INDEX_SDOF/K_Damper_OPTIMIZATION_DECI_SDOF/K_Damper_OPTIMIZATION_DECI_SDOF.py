...
def SDOF(K_OD, MAT_TYPE, TOTAL_MASS, ANAL_TYPE):
    ...
    #ops.uniaxialMaterial('BilinearOilDamper', MatTag_C, K_OD, Cd, Fr=1.0, p=1.0, LGap=0.0, NM=1, RelTol=1e-6, AbsTol=1e-10, MaxHalf=15)
...
# ---------------------------------------------------------------------------------
# FIND THE OPTIMUM VALUE (NEWTON-RAPHSON SOLVER FOR OPTIMAL DAMPER STIFFNESS)
# ---------------------------------------------------------------------------------
import time as TI
import numpy as np
...
DATA = SDOF(K_OD, MAT_TYPE, TOTAL_MASS, ANAL_TYPE)
