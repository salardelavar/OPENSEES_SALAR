...
#%%----------------------------------------------------
def SDOF(K_OD, MAT_TYPE, TOTAL_MASS, ANAL_TYPE):
    # Initialize model
    ops.wipe()
...
#%%----------------------------------------------------
# ----------------------------------------------------------------------------------------------------
# FIND THE OPTIMUM VALUE (NEWTON-RAPHSON SOLVER FOR OPTIMAL DAMPER STIFFNESS) WITH PARALLEL COMPUTING
# ----------------------------------------------------------------------------------------------------
import time as TI
...
def OPTIMIZE_K_OD():
    X = 100000        # Intial Guess for X -> Damper Stiffness of Structure
    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        while RESIDUAL > TOLERANCE and IT < ITMAX:
            ...
            if RESIDUAL < TOLERANCE:
                print(f'\t\t Optimum X (DAMPER STIFFNESS):     {X:.4f}')
