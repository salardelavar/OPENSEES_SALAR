...
# COMPREHENSIVE NONLINEAR SEISMIC ASSESSMENT OF A MULTI-DEGREE-FREEDOM SOIL STRUCTURE SYSTEM : AN OPENSEES#
...
###########################################################################################################
"""
Nonlinear Seismic Performance Assessment of a MDOF Soil Structure System:
An OpenSeesPy Framework for Material and Geometric Nonlinearity Under Static, Cyclic, and Earthquake Loading

This OpenSeesPy script performs rigorous nonlinear static and dynamic analysis of a MDOF Soil Structure System
...
#%%----------------------------------------------------
def SOIL_STRUCTURE_MDOF(MAT_TYPE, TOTAL_MASS):
    # Initialize model
    ops.wipe()
    ...
    # [kg] Mass
    MASS = [0.90 * TOTAL_MASS, 0.10 * TOTAL_MASS]  
    # Damping ratio
    DRi = [0.10, 0.01]      
...
DATA = SOIL_STRUCTURE_MDOF(MAT_TYPE, TOTAL_MASS)
...
# Save to Excel
with pd.ExcelWriter("SOIL_STRUCTURE_MDOF_8_ANA_OUTPUT.xlsx", engine='openpyxl') as writer:
