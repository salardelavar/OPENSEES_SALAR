...
def WARREN_TRUSS_BRIDGE(L, H, A_chord, A_diag, MAT_TYPE,
    ...
    if ANAL_TYPE == 'STATIC': 
        ...
        DATA = (reaction, disp_mid,
                ele_axialforce, ele_stress, ele_strain,
    ...
    if ANAL_TYPE == 'STATIC_EXTERNAL_TIME-DEPENDENT_LOADING': # STATIC TIME-HISTORY ANALYSIS
        ...
        while stable == 0 and current_step < duration:
...
DATA = WARREN_TRUSS_BRIDGE(L, H, A_chord, A_diag, MAT_TYPE, ELE_TYPE, ANAL_TYPE, TOTAL_MASS)
(reaction, disp_mid, 
 ele_force, ele_stress, ele_strain,
 node_displacementsX, node_displacementsY,
 dispX, dispY) = DATA
...
(reaction_PUSH, disp_mid_PUSH, 
 ele_force_PUSH, ele_stress_PUSH, ele_strain_PUSH,
...
(reaction_CP, disp_mid_CP, 
 ele_force_CP, ele_stress_CP, ele_strain_CP,
...
(reaction_ETDLS, disp_mid_ETDLS, 
 ele_force_ETDLS, ele_stress_ETDLS, ele_strain_ETDLS,
...
ele_force_ETDLD, ele_stress_ETDLD, ele_strain_ETDLD,
...
ele_force_FV, ele_stress_FV, ele_strain_FV,
...
(time_SEI, reaction_SEI, disp_mid_SEI,
 ele_axialforce_SEI, ele_stress_SEI, ele_strain_SEI,
