...
def EXTERNAL_TIME_DEPENDENT_LOAD_MDOF(SPRING_TYPE, MAT_TYPE, duration, dt):
    ...
    ops.element('corotTruss', Ele_Tag_03, 2, 3, AREA, MAT_TAG, '-rho',AREA*0.00785 , '-doRayleigh', 1)
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "MDOF_PENDULUM_SIX.json")
#%%-------------------------------------------------------------------------------
# EXCEL OUTPUT
import pandas as pd
...
# Save to Excel
with pd.ExcelWriter("MDOF_PENDULUM_SIX_OUTPUT.xlsx", engine='openpyxl') as writer:
