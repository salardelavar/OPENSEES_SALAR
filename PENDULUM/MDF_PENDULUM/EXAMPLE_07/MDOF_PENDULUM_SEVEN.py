...
omega_DT = 10.0715        # [rad/s] Natural angular frequency
...
# Print the Model
#printModel()
ops.printModel("-JSON", "-file", "MDOF_PENDULUM_SEVEN.json")
#%%-------------------------------------------------------------------------------
# EXCEL OUTPUT
import pandas as pd
...
# Save to Excel
with pd.ExcelWriter("MDOF_PENDULUM_SEVEN_OUTPUT.xlsx", engine='openpyxl') as writer:
