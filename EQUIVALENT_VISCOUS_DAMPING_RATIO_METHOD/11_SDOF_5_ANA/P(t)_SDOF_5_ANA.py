...
#    COMPREHENSIVE EVALUATION OF THE EQUIVALENT VISCOUS DAMPING RATIO OF A NONLINEAR SDOF SYSTEM UNDER    #
...
#%%----------------------------------------------------
def SDOF(MAT_TYPE, TOTAL_MASS, ANAL_TYPE):
    # Initialize model
    ops.wipe()
...
DATA = SDOF(MAT_TYPE, TOTAL_MASS, ANAL_TYPE)
