...
#       COMPREHENSIVE EVALUATION OF THE EQUIVALENT VISCOUS DAMPING RATIO OF A NONLINEAR SDOF SYSTEM       #
#                     WITH FOUR ELEMENTS STRUCTURE UNDER MULTIPLE LOADING PROTOCOLS                       #                                   #
#---------------------------------------------------------------------------------------------------------#
...
#%%----------------------------------------------------
def SDOF_FOUR_ELEMENTS(MAT_TYPE, TOTAL_MASS, ANAL_TYPE):
    # Initialize model
    ops.wipe()
...
DATA = SDOF_FOUR_ELEMENTS(MAT_TYPE, TOTAL_MASS, ANAL_TYPE)
...
# Save to Excel
with pd.ExcelWriter("SDOF_FOUR_ELEMENTS_5_ANA_OUTPUT.xlsx", engine='openpyxl') as writer:
