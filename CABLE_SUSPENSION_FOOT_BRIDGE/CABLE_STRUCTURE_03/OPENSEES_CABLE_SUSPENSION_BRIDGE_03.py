...
def plot_shapes(initial_coords, displacements):
    ...
    for i in range(num_nodes):
        plt.plot([initial_coords[i, 0], initial_coords[i, 0]],
                 [initial_coords[i, 1], initial_coords[i, 1]], 'c--', label='Initial Connecting Elements' if i == 0 else "")
        plt.plot([deformed_coords[i, 0], deformed_coords[i, 0]],
                 [deformed_coords[i, 1], deformed_coords[i, 1]], 'm--', label='Deformed Connecting Elements' if i == 0 else "")
...
u0 = 0.01              # [mm] Initial displacement
...
MAX_ITERATIONS = 10000  # Maximum number of iterations
MAX_TOLERANCE = 1.0e-8  # Tolerance for convergence
