...
#   PUSHOVER ANALYSIS
# --------------------
def PUSHOVER_ANALYSIS(LINEAR, L, H1, arc_depth, E_cable, Cable_Dia_01, num_nodes, MAX_DISP, disp_incr, MAX_ITERATIONS, MAX_TOLERANCE):
...
# Run the analysis
results = PUSHOVER_ANALYSIS(LINEAR, L, H1, arc_depth, E_cable, Cable_Dia_01, num_nodes, MAX_DISP, disp_incr, MAX_ITERATIONS, MAX_TOLERANCE)
