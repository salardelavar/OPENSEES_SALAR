...
import numpy as np
damage = {
    'Minor Damage Level': {'median1': 0.2, 'beta1': 0.05, 'median2': 5.0, 'beta2': 0.05, 'rho': 0.3},
    'Moderate Damage Level': {'median1': 0.5, 'beta1': 0.05, 'median2': 10.0, 'beta2': 0.05, 'rho': 0.3},
    'Severe Damage Level': {'median1': 0.7, 'beta1': 0.05, 'median2': 5.0, 'beta2': 0.05, 'rho': 0.3},
    'Failure Level': {'median1': 1.0, 'beta1': 0.05, 'median2': 5.0, 'beta2': 0.05, 'rho': 0.3},
}

im1_vals = np.linspace(0.05, 1.5, 500)
im2_vals = np.linspace(1, 25, 500)
