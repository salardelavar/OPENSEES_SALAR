...
SPRING_KIND = 'ELASTIC'
time, reactionE, dispE, velE, accelE, damping_ratioE = FREE_VIBRATION_SDOF(IA, IU, IV, SPRING_KIND, M, C, K, KP, KN, u0, v0, a0, duration, dt)
SPRING_KIND = 'INELASTIC'
time, reactionI, dispI, velI, accelI, damping_ratioI = FREE_VIBRATION_SDOF(IA, IU, IV, SPRING_KIND, M, C, K, KP, KN, u0, v0, a0, duration, dt)
