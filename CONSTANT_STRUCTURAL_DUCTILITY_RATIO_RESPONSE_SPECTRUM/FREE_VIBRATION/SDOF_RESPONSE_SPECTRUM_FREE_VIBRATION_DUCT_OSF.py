...
#---------------------------------------------------------------------------------------------------------#
#    INVESTIGATION OF THE EFFECTS OF SDOF STRUCTURAL DUCTILITY ON DAMAGE LEVEL AND STRUCTURAL DAMPING     #
...
u0 = 0.0244       # [m] Initial displacement
...
#%%------------------------------------------------------------------------------------------------
### OPENSEES FUNCTION
def ANALYSIS_SDOF(m, duct, osf, u0):
    ...
    while stable == 0 and current_time < duration:
        ...
        di = S066.DAMAGE_INDEX_FUN(displacement[-1], DY, DSU)
...
DATA = {
    ...
    10: [],  # EQUIVALENT VISCOUS DAMPING RATIO
    }
...
for j in range(NUM_SIM):
    ...
    for i in range(NUM_PERIOD):
        ...
        data = ANALYSIS_SDOF(m, duct[j], osf[j], U0[j])
        ...
        zeta = S055.EQUIVALENT_VISCOUS_DAMPING_RATIO_FUN(displacement, base_reaction, method, XLABEL, YLABEL, TITLE, PLOT)
...
labels = {
    ...
    10: "EQUIVALENT_VISCOUS_DAMPING_RATIO",
}

with pd.ExcelWriter("SDOF_RESPONSE_SPECTRUM_FREE_VIBRATION_DUCT_OSF_RESULTS.xlsx", engine="openpyxl") as writer:
...
mean_eqDR, median_eqDR = PLOT_2D(10, XLABEL, YLABEL, TITLE, SEMILOGY)
#%%------------------------------------------------------------------------------
# --------------------------------------------------------------
...
results_df.to_excel('SDOF_RESPONSE_SPECTRUM_FREE_VIBRATION_DUCT_OSF_LAST_ANALYSIS_DATA_RESULTS.xlsx', index=False)
#%%------------------------------------------------------------------------------------------------  
XLABEL = 'Displacement'
