...
#            NONLINEAR DYNAMIC ANALYSIS UNDER FREE-VIBRAION COMPUTATION AND VISUALIZATION                 #
...
results_df.to_excel('INELASTIC_RESPONSE_SPECTRUM_FREE-VIBRATION_SDOF_LAST_ANALYSIS_DATA_RESULTS.xlsx', index=False)
#%%------------------------------------------------------------------------------------------------  
XLABEL = 'Displacement'
