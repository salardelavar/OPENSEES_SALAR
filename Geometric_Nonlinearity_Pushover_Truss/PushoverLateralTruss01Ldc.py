...
plt.plot(D1, F1, label='Python', color='black', linewidth=4)
plt.plot(dispP, forces, label='OpenSees', color='r', linestyle='--', linewidth=4)
plt.plot(AbaqX, AbaqY, label='Abaqus', color='purple', linestyle='--', linewidth=4)
plt.plot(SeiX, SeiY, label='SeismoStruct', color='cyan', linestyle='--', linewidth=4)
